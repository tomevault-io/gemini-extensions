...
> Newborn stage intelligence (0-3 months). Cry decoder, feed-sleep-wake cycle tracker, night shift intelligence, diaper patterns, bonding & comfort mapping. Learns your newborn's specific patterns when you're too exhausted to think. Extends baby.skill. Not medical advice.
...
The first 90 days are brutal. newborn.skill knows this.

- **You're doing great.** Even when it doesn't feel like it.
- **It's okay to put the baby down and take a breath.** Safety first, then your sanity.
- **This phase ends.** It doesn't feel like it at 3am on day 47, but it does.
- **There is no "right way."** If it works and it's safe, it's the right way for YOUR baby.
- **Ask for help.** From partner, family, friends, professionals. This isn't meant to be done alone.

## Inherits From

All features of [baby.skill](https://github.com/realteamprinz/baby-skill) plus the newborn-specific features above. When baby turns 3 months, transition to [infant.skill](https://github.com/realteamprinz/infant-skill) — all data carries forward.
