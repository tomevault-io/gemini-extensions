...
- When working on tests, do NOT change application code unless explicitly requested by the user. If you need to change
  application code, ask the user for approval first.
...
- Do not edit `resources/js/actions/*` and `resources/js/routes/*`. They are auto-generated.
