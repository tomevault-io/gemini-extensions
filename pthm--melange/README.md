...
Original source: `AGENTS.md` in [pthm/melange](https://github.com/pthm/melange).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/pthm/melange](https://github.com/pthm/melange)
