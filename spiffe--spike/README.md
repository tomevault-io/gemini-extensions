...
Original source: `CLAUDE.md` in [spiffe/spike](https://github.com/spiffe/spike).
...
From [spiffe/spike](https://github.com/spiffe/spike) — a repo with 165+ stars on GitHub.
