...
Original source: `CLAUDE.md` in [andresharpe/dotbot](https://github.com/andresharpe/dotbot).
...
From [andresharpe/dotbot](https://github.com/andresharpe/dotbot) — a repo with 48+ stars on GitHub.
