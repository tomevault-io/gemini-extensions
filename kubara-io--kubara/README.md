...
Original source: `AGENTS.md` in [kubara-io/kubara](https://github.com/kubara-io/kubara).
...
From [kubara-io/kubara](https://github.com/kubara-io/kubara) — a repo with 245+ stars on GitHub.
