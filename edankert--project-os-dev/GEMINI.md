...
> - Prefer Obsidian wiki links using the **filename without .md** (e.g. TASK-0001-Foo), not full paths. - This implies filenames should be unique across the docs set; if a filename is not unique, use a 
