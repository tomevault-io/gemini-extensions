...
> The alint check --format agent report: a flat violations array, a templated agent_instruction per finding, lowercase severities, stable behind schema_version 1.
