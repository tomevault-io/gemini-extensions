...
> Conventions for using the Coinbase.Net library when working with Coinbase Advanced Trade, Coinbase App, or Coinbase Exchange APIs in C#/.NET. Apply when generating code that interacts with Coinbase.
