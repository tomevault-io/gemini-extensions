# AI instruction files for claude-unity-bridge
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/ManageXR/claude-unity-bridge](https://github.com/ManageXR/claude-unity-bridge)
