...
> Apply when creating, editing, reviewing, or refactoring Go API code. Enforce project Go versions, API architecture conventions, idiomatic HTTP design, and production-ready implementation practices.
