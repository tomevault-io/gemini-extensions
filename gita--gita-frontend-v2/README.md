...
Original source: `.cursor/rules/*.mdc` in [gita/gita-frontend-v2](https://github.com/gita/gita-frontend-v2).
...
```
npx tomevault install gita/gita-frontend-v2
```
Source: [github.com/gita/gita-frontend-v2](https://github.com/gita/gita-frontend-v2).
