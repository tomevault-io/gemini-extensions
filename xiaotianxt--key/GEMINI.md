...
> Use when Codex needs to store, retrieve, check, delete, or import local-only API keys in macOS Keychain through the `key` CLI without exposing secret values.
