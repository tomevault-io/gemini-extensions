...
Original source: `copilot-instructions.md` in [spences10/mcp-omnisearch](https://github.com/spences10/mcp-omnisearch).
...
From [spences10/mcp-omnisearch](https://github.com/spences10/mcp-omnisearch) — a repo with 308+ stars on GitHub.
