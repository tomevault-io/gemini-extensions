## e2e-seed-id-text-limits

> E2E seed fixture id_text values must fit nano_id_v2 (9–15 characters). Count length before adding IDs to seed scripts or seedConstants.
