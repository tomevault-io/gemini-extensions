...
> The reuse habit covers hooks and plain functions, not just components — search for an existing implementation before writing one, and collapse a duplicate when you find it
