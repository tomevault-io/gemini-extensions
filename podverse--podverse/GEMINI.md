## dto-changes-are-device-data-migrations

> Treat persisted DTOs and Add-by-RSS parse bundles as device data migrations; trace server, parser, SQLite, and offline playback contracts
