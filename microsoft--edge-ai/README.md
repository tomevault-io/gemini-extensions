...
> Tome by [microsoft](https://github.com/microsoft/edge-ai) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `copilot-instructions.md` in [microsoft/edge-ai](https://github.com/microsoft/edge-ai).
...
From [microsoft/edge-ai](https://github.com/microsoft/edge-ai) — a repo with 81+ stars on GitHub.
