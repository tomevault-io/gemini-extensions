# AI instruction files for toyoura-nagisa

> Sourced from [yusong652/toyoura-nagisa](https://github.com/yusong652/toyoura-nagisa) and converted for every major platform by [TomeVault](https://tomevault.io)
