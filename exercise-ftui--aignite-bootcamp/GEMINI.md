...
> Generate Tasks: A rule for converting Product Requirements Documents (PRDs) into structured, developer-ready task lists with parent tasks, sub-tasks, and relevant file identification.
