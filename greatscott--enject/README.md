...
Original source: `CLAUDE.md` in [GreatScott/enject](https://github.com/GreatScott/enject).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/GreatScott/enject](https://github.com/GreatScott/enject)
