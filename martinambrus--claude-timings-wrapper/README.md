...
Original source: `AGENTS.md` in [martinambrus/claude_timings_wrapper](https://github.com/martinambrus/claude_timings_wrapper).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/martinambrus/claude_timings_wrapper](https://github.com/martinambrus/claude_timings_wrapper)
