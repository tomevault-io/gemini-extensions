...
Original source: `AGENTS.md` in [xinggaoya/sing-box-windows](https://github.com/xinggaoya/sing-box-windows).
...
```
npx tomevault install xinggaoya/sing-box-windows
```
Source: [github.com/xinggaoya/sing-box-windows](https://github.com/xinggaoya/sing-box-windows).
