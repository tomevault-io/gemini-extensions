...
> Use this rule when setting up the development environment, running the application, managing dependencies, or following the project's development process. Essential for getting started and maintaining the development workflow.
