...
Original source: `AGENTS.md` in [gabelul/stitch-kit](https://github.com/gabelul/stitch-kit).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/gabelul/stitch-kit](https://github.com/gabelul/stitch-kit)
