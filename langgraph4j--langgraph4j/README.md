# AI instruction files for langgraph4j

> Sourced from [langgraph4j/langgraph4j](https://github.com/langgraph4j/langgraph4j), graded against the public Tome Standard and kept consistent across every major platform by [TomeVault](https://tomevault.io)
