...
> Conventions for using Polymarket.Net when working with Polymarket prediction market APIs in C#/.NET. Apply when generating code that interacts with Polymarket.
