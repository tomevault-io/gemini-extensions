...
## Fluent / Windows UI
- This project uses a flutter package implementation inspired by [Microsoft's Fluent / Windows UI](https://docs.microsoft.com/en-us/windows/uwp/design)
- The flutter package is located [here](https://pub.dev/packages/fluent_ui)
- API Reference for the `fluent_ui` flutter package can be found [here](https://pub.dev/documentation/fluent_ui/latest/)
