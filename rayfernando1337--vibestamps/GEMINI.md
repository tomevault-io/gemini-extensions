...
> Reference guide for the Vercel AI SDK, including links to documentation, core concepts, API reference, and usage examples for integrating AI models like Gemini.
