...
Original source: `AGENTS.md` in [vercel/sandbox](https://github.com/vercel/sandbox).
...
From [vercel/sandbox](https://github.com/vercel/sandbox) — a repo with 108+ stars on GitHub.
