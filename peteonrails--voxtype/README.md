...
> Tome by [peteonrails](https://github.com/peteonrails/voxtype) — distributed by [TomeVault](https://tomevault.io/claim/peteonrails)

AI instruction files for voxtype by peteonrails

## Gemini CLI Config

The `GEMINI.md` file in this directory is the project config converted for Gemini CLI.
Original source: `CLAUDE.md` in [peteonrails/voxtype](https://github.com/peteonrails/voxtype).
...
Is this your repo? [Claim it](https://tomevault.io/claim/peteonrails) to manage distribution.
