...
Original source: `CLAUDE.md` in [LeakIX/HttpIOCScan](https://github.com/LeakIX/HttpIOCScan).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/LeakIX/HttpIOCScan](https://github.com/LeakIX/HttpIOCScan)
