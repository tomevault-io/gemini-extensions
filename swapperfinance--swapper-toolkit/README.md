...
Original source: `CLAUDE.md` in [swapperfinance/swapper-toolkit](https://github.com/swapperfinance/swapper-toolkit).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/swapperfinance/swapper-toolkit](https://github.com/swapperfinance/swapper-toolkit)
