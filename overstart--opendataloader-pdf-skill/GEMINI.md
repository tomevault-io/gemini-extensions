...
> PDF解析提取转换工具，当用户提到解析pdf、转换pdf、提取pdf内容、pdf转markdown、pdf转json、pdf提取文本时使用，基于opendataloader-pdf实现，支持输出Markdown、JSON、HTML、Tagged PDF等多种格式，100%本地运行无需联网，处理速度快准确率高。
