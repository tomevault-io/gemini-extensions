...
Original source: `CLAUDE.md` in [kytmanov/obsidian-llm-wiki-local](https://github.com/kytmanov/obsidian-llm-wiki-local).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/kytmanov/obsidian-llm-wiki-local](https://github.com/kytmanov/obsidian-llm-wiki-local)

---

Install this config instantly:
```
npx tomevault install kytmanov/obsidian-llm-wiki-local
```
