...
Reusable playbooks live in `.claude/skills/`: `api-design`, `architecture-review`, `ci-cd`, `code-review`, `debugging`, `documentation`, `log-analysis`, `performance-tuning`, `project-tailoring`, `refactoring`, `security-review`, `skill-author`, `testing`.
