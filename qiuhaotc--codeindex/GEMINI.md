...
> Use when writing C# code in this project. Covers naming conventions, parameter validation, error handling, logging, thread safety, and FetchResult patterns specific to CodeIndex.
