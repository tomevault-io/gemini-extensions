...
Original source: `CLAUDE.md` in [Silentely/eSIM-Tools](https://github.com/Silentely/eSIM-Tools).
...
```
npx tomevault install Silentely/eSIM-Tools
```
Source: [github.com/Silentely/eSIM-Tools](https://github.com/Silentely/eSIM-Tools).
