...
**Archived skills** in `skills/archived/` are the original individual skills that have been consolidated. They are kept for reference but are not loaded by Codex.
...
**List available skills:** just ask Codex — skill names and descriptions are injected into context at session start at zero token cost.
...
**Documentation**: https://dmccreary.github.io/Codex-skills/
**Repository**: https://github.com/dmccreary/Codex-skills
