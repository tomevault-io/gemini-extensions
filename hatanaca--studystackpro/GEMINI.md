...
> Especialista em integração e debug full-stack StudyTrackPro — rastrear falhas de ponta a ponta (DB → Laravel → Redis/Queue → Reverb → Vue), sincronizar contratos e validar fluxos completos
