...
`Stable v1.4.0 maintenance and public-surface alignment`
...
---
> Source: [tsubotti63/garmin-running-data-normalizer](https://github.com/tsubotti63/garmin-running-data-normalizer) — distributed by [TomeVault](https://tomevault.io).
