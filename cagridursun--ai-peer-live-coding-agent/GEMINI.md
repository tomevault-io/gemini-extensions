## readme-first-spec-writing

> README-first specification rules for live coding interviews. Focus on scope, API contracts, edge cases, and optional conceptual Mermaid diagrams. No code.
