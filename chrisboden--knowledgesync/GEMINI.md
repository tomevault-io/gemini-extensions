...
> Guide to building AI features with LLM API's
...
OpenRouter supports structured outputs for compatible models (like GPT-4o-mini and later versions), ensuring responses follow a specific JSON Schema format. This is particularly useful when you need consistent, well-formatted responses that can be reliably parsed by your application.
...
- OpenAI models (GPT-4o-mini and later)
...
Note that the default model you should use is `openai/gpt-4o-mini`
    ...
    "data": [
        {
            ...
            "name": "GPT-4o-Mini",
            "description": "Workhorse openai model...",
            "pricing": {
                "prompt": "0.01",
                "completion": "0.03"
            },
