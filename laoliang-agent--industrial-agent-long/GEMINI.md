...
- Production-grade design decisions are specced in `docs/superpowers/specs/2026-06-28-production-upgrade-design.md` — consult it before large changes to the runtime/tool/guardrail layers.
