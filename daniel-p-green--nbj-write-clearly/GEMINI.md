...
- Do not copy large passages from the Google guide. Paraphrase, link, and preserve attribution.
...
---
> Source: [daniel-p-green/nbj-write-clearly](https://github.com/daniel-p-green/nbj-write-clearly) — distributed by [TomeVault](https://tomevault.io).
