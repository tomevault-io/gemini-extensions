...
> After Prisma schema changes, create a migration and commit it with the schema. Covers both the PG track (prisma/schema.prisma) and the desktop SQLite track (prisma/schema.local.prisma).
