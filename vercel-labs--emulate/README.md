...
Original source: `AGENTS.md` in [vercel-labs/emulate](https://github.com/vercel-labs/emulate).
...
```
npx tomevault install vercel-labs/emulate
```
Source: [github.com/vercel-labs/emulate](https://github.com/vercel-labs/emulate).
