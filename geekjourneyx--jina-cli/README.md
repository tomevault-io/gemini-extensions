...
Original source: `CLAUDE.md` in [geekjourneyx/jina-cli](https://github.com/geekjourneyx/jina-cli).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/geekjourneyx/jina-cli](https://github.com/geekjourneyx/jina-cli)
