...
- TikTok-style captions: `--karaoke` keeps the whole phrase on screen and rides a purple box
  over the active word. Identical font/spacing/position to the default captions (Arial Black),
  just with the box added. Independent of `--no-captions`.
