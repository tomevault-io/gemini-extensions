# AI instruction files for XcodeBuildMCP

> Sourced from [getsentry/XcodeBuildMCP](https://github.com/getsentry/XcodeBuildMCP) and converted for every major platform by [TomeVault](https://tomevault.io)
