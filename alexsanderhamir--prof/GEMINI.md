...
> Enforce Microsoft Learn documentation standards when writing or reviewing developer-facing docs. Rewrite existing content only when it violates these rules.
