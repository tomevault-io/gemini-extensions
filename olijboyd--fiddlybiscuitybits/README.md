...
> Tome by [olijboyd](https://github.com/olijboyd/fiddlybiscuitybits) — distributed by [TomeVault](https://tomevault.io/claim/olijboyd)

AI instruction files for fiddlybiscuitybits by olijboyd

## Gemini CLI Config

The `GEMINI.md` file in this directory is the project config converted for Gemini CLI.
Original source: `CLAUDE.md` in [olijboyd/fiddlybiscuitybits](https://github.com/olijboyd/fiddlybiscuitybits).
