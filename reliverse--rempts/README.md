...
Original source: `.cursor/rules/*.mdc` in [reliverse/rempts](https://github.com/reliverse/rempts).
...
From [reliverse/rempts](https://github.com/reliverse/rempts) — a repo with 31+ stars on GitHub.
