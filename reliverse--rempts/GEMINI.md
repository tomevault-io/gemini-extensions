...
- Avoid await inside loops unless sequential execution is required.
- Avoid bitwise operators except for low-level performance code.
...
- Don't throw non-Error values (always throw Error or subclasses).
