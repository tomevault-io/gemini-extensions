...
Original source: `CLAUDE.md` in [AmElmo/proofshot](https://github.com/AmElmo/proofshot).
...
From [AmElmo/proofshot](https://github.com/AmElmo/proofshot) — a repo with 794+ stars on GitHub.
