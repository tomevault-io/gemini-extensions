...
> Use when writing or editing C++ source files (cpp/hpp/h/cc/cxx) in licensecc. Covers RAII, value semantics, const-correctness, C++11 constraints, smart-pointer construction, exception safety across the C API boundary, and common pitfalls like dangling c_str() and temporaries bound to references.
