...
- `docs/` — human-facing pages per skill, published
- changesets and `package.json` versioning
- CI running `claude plugin validate --strict`
- per-plugin `README.md`
- an eval suite that discriminates — see `CLAUDE.local.md`.
