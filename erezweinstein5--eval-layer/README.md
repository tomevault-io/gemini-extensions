...
Original source: `CLAUDE.md` in [erezweinstein5/eval-layer](https://github.com/erezweinstein5/eval-layer).
...
From [erezweinstein5/eval-layer](https://github.com/erezweinstein5/eval-layer) — a repo with 7+ stars on GitHub.
