...
Original source: `AGENTS.md` in [Dicklesworthstone/meta_skill](https://github.com/Dicklesworthstone/meta_skill).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/Dicklesworthstone/meta_skill](https://github.com/Dicklesworthstone/meta_skill)
