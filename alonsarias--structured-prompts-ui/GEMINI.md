...
> Client-side data fetching patterns with SWR for automatic deduplication, event listener management, passive scroll listeners, and localStorage/sessionStorage caching. Use when fetching data, managing API requests, handling scroll events, or working with browser storage.
