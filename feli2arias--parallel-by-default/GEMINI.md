...
> Use when Claude is executing multiple tasks sequentially that could run simultaneously, or when dispatching subagents one at a time for independent work.
