...
Original source: `CLAUDE.md` in [rynfar/meridian](https://github.com/rynfar/meridian).
...
From [rynfar/meridian](https://github.com/rynfar/meridian) — a repo with 878+ stars on GitHub.
