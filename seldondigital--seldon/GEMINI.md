...
> Sync the components catalog index, constants, and component id from component schema files. Use when invoking @components-catalog or when asked to sync or verify the component catalog.
