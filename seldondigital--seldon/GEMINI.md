...
> Seldon theme and token conventions
...
When adding a new token kind or section, update the matching types, values, constants, schemas, exports, and section ordering described in `packages/core/themes/README.md`.
