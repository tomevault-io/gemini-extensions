...
Use authored Go Story E2E tests as the canonical browser specs. `just e2e` is the default runner-owned path; it manages server lifecycle and artifacts. Use Playwright directly only for ad hoc investigation that cannot be expressed as a story yet.
