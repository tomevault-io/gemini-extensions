...
> Activate the Go Developer persona by following the agent definition below. This rule provides specialized development assistance for go developer-related tasks.

# Go Developer Agent Rule
