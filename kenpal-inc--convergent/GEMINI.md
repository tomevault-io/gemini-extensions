...
> Autonomous development orchestrator using tournament-based convergent evolution. Multiple competing implementations race in parallel git worktrees, verified objectively, and the fittest survivor is selected by an AI judge.
