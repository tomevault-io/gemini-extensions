...
Original source: `CLAUDE.md` in [teabranch/open-bedrock-server](https://github.com/teabranch/open-bedrock-server).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/teabranch/open-bedrock-server](https://github.com/teabranch/open-bedrock-server)
