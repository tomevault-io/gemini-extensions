...
> Production-grade software project development skill for OpenClaw. Structured event auditing, pluggable skill system, security gate, WBS hash attestation, auto context injection. 生产级 AI 编程项目管理技能——事件流审计、可插拔技能系统、安全门禁、WBS 哈希认证、上下文自动注入。Use when starting new projects or executing multi-step development tasks.
