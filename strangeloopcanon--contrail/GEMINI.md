...
- Rust toolchain is already installed and working.
- Do NOT run `rustup`, `rustup-init`, or any installer scripts.
- Do NOT run long-lived commands like `cargo watch` or dev servers.
- Only use:
  - `cargo check`
  - `cargo test`
  - `cargo fmt`
