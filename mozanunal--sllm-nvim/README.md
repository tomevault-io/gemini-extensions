...
Original source: `CLAUDE.md` in [mozanunal/sllm.nvim](https://github.com/mozanunal/sllm.nvim).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/mozanunal/sllm.nvim](https://github.com/mozanunal/sllm.nvim)
