...
- Append session to `~/knowledge/daily/YYYY-MM-DD-alex-mbp.md`
- Commit KB and push (`cd ~/knowledge && git pull --rebase && git push`)
- Commit this repo (no auto-sync — manual push to origin)
