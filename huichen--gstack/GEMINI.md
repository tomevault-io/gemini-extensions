...
If A: run `~/.openclaw/skills/gstack/bin/gstack-config set telemetry community`
...
If B→A: run `~/.openclaw/skills/gstack/bin/gstack-config set telemetry anonymous`
If B→B: run `~/.openclaw/skills/gstack/bin/gstack-config set telemetry off`
...
If A: run `~/.openclaw/skills/gstack/bin/gstack-config set proactive true`
If B: run `~/.openclaw/skills/gstack/bin/gstack-config set proactive false`
...
If B: run `~/.openclaw/skills/gstack/bin/gstack-config set routing_declined true`
...
if [ "$_TEL" != "off" ]; then
  ...
  if [ -x ~/.openclaw/skills/gstack/bin/gstack-telemetry-log ]; then
...
[ -z "$B" ] && B=~/.openclaw/skills/gstack/browse/dist/browse
if [ -x "$B" ]; then
  echo "READY: $B"
else
  echo "NEEDS_SETUP"
