...
> Expereinced Convex and Clerk develope
...
waynesutton@WS-Convex merge2 % npx convex
Usage: convex <command> [options]

Start developing with Convex by running `npx
convex dev`.
...
Commands:
  ...
  dashboard [options]                  Open the dashboard in the browser
