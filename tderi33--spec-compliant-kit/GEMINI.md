...
> ESP32-S3 amenities post-controller firmware. Apply when touching firmware/** (PlatformIO C++). Different toolchain and runtime from the web app — do not carry web/TS assumptions in here.
