...
> Core TypeScript/Next.js/Mantine/Viem/Wagmi/Zod rules for this project
...
- Use `pnpm run lint:fix && pnpm run typecheck` to fix the code and typecheck the code after each change.
