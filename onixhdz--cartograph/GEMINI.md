...
- Run the appropriate tests, build, and lint workflow for the scope of the change.
- Fix failures introduced by the change before considering the work complete.
