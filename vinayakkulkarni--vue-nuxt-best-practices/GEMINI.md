...
**Impact:** CRITICAL - Interactive edge auth (Cloudflare Access, SSO) in front of an agent API silently serves HTML login pages to agents instead of JSON — every MCP/CLI client breaks with a non-obvious failure
