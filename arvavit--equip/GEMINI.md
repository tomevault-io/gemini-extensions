...
This is a **transparency** convention, not a gate. It exists so the history
shows honestly how the codebase got built.
...
contradiction is clearly a bug. Say so in the PR description rather than
