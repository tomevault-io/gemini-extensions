...
Original source: `.cursor/rules/*.mdc` in [J-Pster/Psters_AI_Workflow](https://github.com/J-Pster/Psters_AI_Workflow).
...
From [J-Pster/Psters_AI_Workflow](https://github.com/J-Pster/Psters_AI_Workflow) — a repo with 287+ stars on GitHub.
