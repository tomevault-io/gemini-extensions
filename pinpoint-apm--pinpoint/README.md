# AI instruction files for pinpoint

> Sourced from [pinpoint-apm/pinpoint](https://github.com/pinpoint-apm/pinpoint), graded against the public Tome Standard and kept consistent across every major platform by [TomeVault](https://tomevault.io)
...
```
npx tomevault install pinpoint-apm/pinpoint
```
Source: [github.com/pinpoint-apm/pinpoint](https://github.com/pinpoint-apm/pinpoint).
