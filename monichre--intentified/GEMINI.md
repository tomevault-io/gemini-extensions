...
## [**​**](https://docs.exa.ai/examples/company-analyst#finding-additional-info-for-each-company)
...
[**RAG Q&A**](https://docs.exa.ai/examples/exa-rag)[**Exa Researcher - JavaScript**](https://docs.exa.ai/examples/exa-researcher)
...
**On this page**
- [**What this doc covers**](https://docs.exa.ai/examples/company-analyst#what-this-doc-covers)
- [Shortcomings of Google](https://docs.exa.ai/examples/company-analyst#shortcomings-of-google)
- [What is neural search?](https://docs.exa.ai/examples/company-analyst#what-is-neural-search%3F)
- [Finding companies with Exa link similarity search](https://docs.exa.ai/examples/company-analyst#finding-companies-with-exa-link-similarity-search)
- [Finding additional info for each company](https://docs.exa.ai/examples/company-analyst#finding-additional-info-for-each-company)
- [Creating a report with LLMs](https://docs.exa.ai/examples/company-analyst#creating-a-report-with-llms)
