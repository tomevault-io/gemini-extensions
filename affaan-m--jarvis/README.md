...
Original source: `AGENTS.md` in [affaan-m/JARVIS](https://github.com/affaan-m/JARVIS).
...
From [affaan-m/JARVIS](https://github.com/affaan-m/JARVIS) — a repo with 89+ stars on GitHub.
