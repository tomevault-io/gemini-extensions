...
> Operate Multica through the authenticated `multica` CLI (issues, comments, metadata, mentions, status). Use whenever the user asks to read, triage, reply to, or update Multica issues or other Multica resources.
