...
- Our PR has been open >30 days with no review (maintainer likely unresponsive)

**How to check and close:**
```bash
...
Never leave dead PRs open -- it looks unprofessional and clutters maintainers' view.

## Learn from Top OSS Contributors

Study how elite contributors operate:

**Patterns of successful contributors (from research):**
- They contribute to 2-3 repos deeply, not 50 repos shallowly
- They respond to review comments within hours, not days
- They follow up on merged PRs with related improvements
- They participate in discussions and issues beyond just code
- They have clean, focused PRs (one concern per PR)
- They write excellent PR descriptions that explain WHY, not just WHAT
- They include tests and documentation proactively
- They build relationships with maintainers over time

**Repos worth contributing to for REPUTATION alone (no bounty needed):**
...
- Any CNCF project (Kubernetes ecosystem)
- Any Apache project

Being a contributor to these repos is worth more than a $500 bounty from an unknown repo.
