...
Original source: `AGENTS.md` in [oracle/agent-spec](https://github.com/oracle/agent-spec).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/oracle/agent-spec](https://github.com/oracle/agent-spec)
