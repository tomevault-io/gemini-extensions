...
> Session watcher that forwards OpenClaw assistant responses to Unity 3D visualization. Monitors session files and sends messages via HTTP bridge to Unity WebGL.
