...
Extensions.Hosting an extension of ReactiveUI and Extensions.Hosting is a cross-platform MVVM framework built on Rx.NET and functional reactive programming principles.

### Core Library (`src/CrissCross/`)
...
* `CrissCross.Wpf/`, `CrissCross.Avalonia/`, `CrissCross.Maui/`, `CrissCross.WinForms/`,
  `CrissCross.Wpf.UI/`, `CrissCross.Avalonia.UI/`, `CrissCross.Wpf.Plot/`, etc.

### Scheduler Abstraction

* Prefer `RxSchedulers` (AOT-friendly, avoids reflection/AOT attribute propagation)
* Do not use `RxApp` this has been removed
...
* Platform-specific code in `src/CrissCross/` core library
