...
> Standards for placing Cursor rule files in the correct directory. Apply when creating new cursor rules, discussing rule organisation, or working with .mdc files.
