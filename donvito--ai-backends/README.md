...
Original source: `.cursor/rules/*.mdc` in [donvito/ai-backends](https://github.com/donvito/ai-backends).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/donvito/ai-backends](https://github.com/donvito/ai-backends)
