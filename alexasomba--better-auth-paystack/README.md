...
> Tome by [alexasomba](https://github.com/alexasomba/better-auth-paystack) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `AGENTS.md` in [alexasomba/better-auth-paystack](https://github.com/alexasomba/better-auth-paystack).
...
From [alexasomba/better-auth-paystack](https://github.com/alexasomba/better-auth-paystack) — a repo with 16+ stars on GitHub.
