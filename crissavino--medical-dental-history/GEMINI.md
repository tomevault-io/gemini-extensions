...
│   └── Requests/       # form request validators (incl. SignEncounterRequest)
├── Services/           # AnamnesisPdfService, EncounterPdfService, ClinicalHistoryPdfService
...
| Sign / Rectify Encounter | ✓ | ✓ | ✗ | ✗ |
| Encounter & Clinical-History PDF | ✓ | ✓ | ✗ | ✗ |
| View Audit Logs | ✓ | ✗ | ✗ | ✗ |
| GDPR Export | ✓ | ✓ | ✗ | ✗ |
