...
Public docs are intentionally minimal: `readme.md` (quick start + "Differences from LiveKit"), `docs/versioning.md` (tag/release policy), `docs/docker-hub-livekit-rs-voice.md` / `docs/docker-hub-livekit-rs-egress.md` (Docker Hub repo descriptions), `docs/benchmark_livekit_rs_voice.md`, `docs/benchmark_livekit_rs_egress.md`, `CHANGELOG.md`. When behavior changes, update `CHANGELOG.md` (Keep a Changelog) and the "Differences from LiveKit" section in `readme.md` if users are affected. Do not create new `.md` docs unless asked.
