...
> Tome by [williamzujkowski](https://github.com/williamzujkowski/standards) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `CLAUDE.md` in [williamzujkowski/standards](https://github.com/williamzujkowski/standards).
...
- [authentication](https://github.com/williamzujkowski/standards/tree/main/skills/security/authentication)
- [authorization](https://github.com/williamzujkowski/standards/tree/main/skills/security/authorization)
- [broken-reference](https://github.com/williamzujkowski/standards/tree/main/tests/scripts/fixtures/skills/broken-reference)
...
- [go](https://github.com/williamzujkowski/standards/tree/main/skills/coding-standards/go)
- [graphql](https://github.com/williamzujkowski/standards/tree/main/skills/api/graphql)
...
- [kotlin](https://github.com/williamzujkowski/standards/tree/main/skills/coding-standards/kotlin)
...
- [missing-level1](https://github.com/williamzujkowski/standards/tree/main/tests/scripts/fixtures/skills/missing-level1)
...
- [python](https://github.com/williamzujkowski/standards/tree/main/skills/coding-standards/python)
- [react](https://github.com/williamzujkowski/standards/tree/main/skills/frontend/react)
- [mobile-react-native](https://github.com/williamzujkowski/standards/tree/main/skills/frontend/mobile-react-native)
- [rust](https://github.com/williamzujkowski/standards/tree/main/skills/coding-standards/rust)
- [service-mesh](https://github.com/williamzujkowski/standards/tree/main/skills/cloud-native/service-mesh)
- [shell](https://github.com/williamzujkowski/standards/tree/main/skills/coding-standards/shell)
...
- [swift](https://github.com/williamzujkowski/standards/tree/main/skills/coding-standards/swift)
- [threat-modeling](https://github.com/williamzujkowski/standards/tree/main/skills/security/threat-modeling)
- [too-long-level1](https://github.com/williamzujkowski/standards/tree/main/tests/scripts/fixtures/skills/too-long-level1)
- [typescript](https://github.com/williamzujkowski/standards/tree/main/skills/coding-standards/typescript)
...
- [valid-skill](https://github.com/williamzujkowski/standards/tree/main/tests/scripts/fixtures/skills/valid-skill)
- [vue](https://github.com/williamzujkowski/standards/tree/main/skills/frontend/vue)

Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/williamzujkowski/standards](https://github.com/williamzujkowski/standards)

---

Install this config instantly:
```
npx tomevault install williamzujkowski/standards
```
Source: [github.com/williamzujkowski/standards](https://github.com/williamzujkowski/standards).
