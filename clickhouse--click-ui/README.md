# AI instruction files for click-ui

> Sourced from [ClickHouse/click-ui](https://github.com/ClickHouse/click-ui), graded against the public Tome Standard and kept consistent across every major platform by [TomeVault](https://tomevault.io)

## Gemini CLI Config

The `GEMINI.md` file in this directory is the project config converted for Gemini CLI.
Original source: `` in [ClickHouse/click-ui](https://github.com/ClickHouse/click-ui).
