...
- Don't eagerly deserialize weight data in parsers - expose bytes via `ModelWeights` and decode in core on demand.
...
- Don't inline exotic dtype shims in parsers - use `@wetron/common/dtypes`.
