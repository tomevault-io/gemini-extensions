...
> Enforce diagnostic-first discipline: enumerate 5–7 plausible sources, narrow to 1–2 most likely, and add targeted logs to validate assumptions before any code fix.
