...
> Tome by [trpc-group](https://github.com/trpc-group/trpc-agent-go) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `AGENTS.md` in [trpc-group/trpc-agent-go](https://github.com/trpc-group/trpc-agent-go).
