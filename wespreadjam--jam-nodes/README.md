...
Original source: `CLAUDE.md` in [wespreadjam/jam-nodes](https://github.com/wespreadjam/jam-nodes).
...
```
npx tomevault install wespreadjam/jam-nodes
```
Source: [github.com/wespreadjam/jam-nodes](https://github.com/wespreadjam/jam-nodes).
