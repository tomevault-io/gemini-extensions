...
**REQUIRED:** Before finishing any session that includes user-facing changes (new features, improvements, bug fixes), you MUST add changelog entries. This is not optional. Do it before the final commit.
