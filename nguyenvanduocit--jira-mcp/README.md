...
Original source: `CLAUDE.md` in [nguyenvanduocit/jira-mcp](https://github.com/nguyenvanduocit/jira-mcp).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/nguyenvanduocit/jira-mcp](https://github.com/nguyenvanduocit/jira-mcp)
