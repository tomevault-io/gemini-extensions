...
> Write prose like a careful human writer. Governs prose deliverables only: documents, README prose, CVs, cover letters, emails, reports. Never source code, comments, commits or config.
