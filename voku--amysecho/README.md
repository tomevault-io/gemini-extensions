...
Original source: `copilot-instructions.md` in [voku/AmysEcho](https://github.com/voku/AmysEcho).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/voku/AmysEcho](https://github.com/voku/AmysEcho)
