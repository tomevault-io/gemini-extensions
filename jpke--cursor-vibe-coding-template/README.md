...
Original source: `.cursor/rules/*.mdc` in [jpke/cursor-vibe-coding-template](https://github.com/jpke/cursor-vibe-coding-template).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/jpke/cursor-vibe-coding-template](https://github.com/jpke/cursor-vibe-coding-template)
