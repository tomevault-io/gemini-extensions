## video-custom-transforms-architecture

> Architecture of the video benchmark system — how video transform spec files work, what BenchmarkRunner expects for video mode, and library-specific calling conventions.
