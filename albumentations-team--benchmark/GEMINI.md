## image-custom-transforms-architecture

> Architecture of the image benchmark system — how transform spec files work, what BenchmarkRunner expects, and how built-in vs custom transforms differ.
