...
Original source: `CLAUDE.md` in [masondelan/selvedge](https://github.com/masondelan/selvedge).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/masondelan/selvedge](https://github.com/masondelan/selvedge)
