...
- The `.grype.yaml` `ignore` list is currently empty — all known high-severity findings have been patched (not suppressed). Prefer patching over adding suppressions; if you must suppress, include a `reason` string.
