...
Original source: `copilot-instructions.md` in [go-swagger/go-swagger](https://github.com/go-swagger/go-swagger).
...
From [go-swagger/go-swagger](https://github.com/go-swagger/go-swagger) — a repo with 9993+ stars on GitHub.
