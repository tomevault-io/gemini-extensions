...
> Simulate any subject as an AI Skill. Import chats, screenshots, photos, documents, and descriptions to build Subject Memory + Persona Engine with iterative updates.
