...
> Deep code analysis using Joern CPG. Analyze dataflow, blast radius, callers/callees instantly. Use when understanding code structure, planning refactors, or assessing change impact.
