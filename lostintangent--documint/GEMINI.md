...
1. Relevant subsystem `AGENTS.md` files are updated when design intent, ownership, or file/folder roles change, using the `codify` skill and `.agents/skills/codify/references/standard.md` as the writing standard.
