...
Original source: `CLAUDE.md` in [khuynh22/mcp-wireshark](https://github.com/khuynh22/mcp-wireshark).
...
From [khuynh22/mcp-wireshark](https://github.com/khuynh22/mcp-wireshark) — a repo with 31+ stars on GitHub.
