...
## Self-Audit Prompts
Portable quality checks in `system/prompts/`. Can be used in any tool via copy-paste.

## Never Do
- Relative imports (always @/ alias)
- Hardcoded colors (always CSS variables)
- Inline styles
- tailwind.config.js / tailwind.config.mjs
- @astrojs/tailwind integration
- HSL colors in @theme (use OKLCH)
- .tsx for static content
- TypeScript `any` type
- Skip responsive design
- Add styles outside globals.css
