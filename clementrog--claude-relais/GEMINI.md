...
> Router-first Claude orchestration skill: fresh repos trigger guided setup, existing repos get next-step options, and BUILD is always dispatched to Cursor headless agent.
