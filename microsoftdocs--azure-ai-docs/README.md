...
Original source: `copilot-instructions.md` in [MicrosoftDocs/azure-ai-docs](https://github.com/MicrosoftDocs/azure-ai-docs).
...
From [MicrosoftDocs/azure-ai-docs](https://github.com/MicrosoftDocs/azure-ai-docs) — a repo with 151+ stars on GitHub.
