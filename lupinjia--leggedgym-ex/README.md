...
Original source: `AGENTS.md` in [lupinjia/LeggedGym-Ex](https://github.com/lupinjia/LeggedGym-Ex).
...
```
npx tomevault install lupinjia/LeggedGym-Ex
```
Source: [github.com/lupinjia/LeggedGym-Ex](https://github.com/lupinjia/LeggedGym-Ex).
