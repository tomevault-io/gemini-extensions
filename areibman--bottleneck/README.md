...
Original source: `AGENTS.md` in [areibman/bottleneck](https://github.com/areibman/bottleneck).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/areibman/bottleneck](https://github.com/areibman/bottleneck)
