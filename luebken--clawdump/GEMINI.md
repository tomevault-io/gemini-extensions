...
> Share OpenClaw context files as a secret GitHub Gist using the clawdump CLI. Use when the user wants to share, export, or back up their OpenClaw configuration.
