...
Original source: `AGENTS.md` in [isaac-sim/IsaacLab-Arena](https://github.com/isaac-sim/IsaacLab-Arena).
...
From [isaac-sim/IsaacLab-Arena](https://github.com/isaac-sim/IsaacLab-Arena) — a repo with 381+ stars on GitHub.
