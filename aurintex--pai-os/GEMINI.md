...
> Technical enforcer for the project's Definition of Done (DoD). This rule ensures that the standards defined in the official documentation are followed before any task is completed.
