...
> Technical enforcer for the documentation hybrid system. Ensures synchronization between Rust code, Protocol Buffer definitions, and the Starlight documentation site.
