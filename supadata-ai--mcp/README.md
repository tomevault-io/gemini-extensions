...
Original source: `CLAUDE.md` in [supadata-ai/mcp](https://github.com/supadata-ai/mcp).
...
From [supadata-ai/mcp](https://github.com/supadata-ai/mcp) — a repo with 46+ stars on GitHub.
