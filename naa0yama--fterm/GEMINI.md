...
- **Tests**: Arrange / Act / Assert pattern. Unit tests in `#[cfg(test)] mod tests`, integration tests in `crates/<name>/tests/`. `#![allow(clippy::unwrap_used)]` is permitted in test code.
