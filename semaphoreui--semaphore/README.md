# AI instruction files for semaphore

> Sourced from [semaphoreui/semaphore](https://github.com/semaphoreui/semaphore), graded against the public Tome Standard and kept consistent across every major platform by [TomeVault](https://tomevault.io)
