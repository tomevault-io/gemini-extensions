...
Metadata uses that same span check on the emitted representative name. Never split at
the first slash: `protein/v1,variant` is a whole protein, and sending its suffix into
