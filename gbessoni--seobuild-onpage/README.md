...
Original source: `CLAUDE.md` in [gbessoni/seobuild-onpage](https://github.com/gbessoni/seobuild-onpage).
...
From [gbessoni/seobuild-onpage](https://github.com/gbessoni/seobuild-onpage) — a repo with 188+ stars on GitHub.
