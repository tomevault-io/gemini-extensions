...
> Use when creating or editing Delphi form files (.dfm). Covers form-via-DFM rules, component naming, layout, and anti-patterns for this plugin's design-time package.
