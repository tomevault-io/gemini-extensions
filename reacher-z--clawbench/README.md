...
Original source: `AGENTS.md` in [reacher-z/ClawBench](https://github.com/reacher-z/ClawBench).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/reacher-z/ClawBench](https://github.com/reacher-z/ClawBench)
