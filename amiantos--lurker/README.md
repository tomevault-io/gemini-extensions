...
Original source: `AGENTS.md` in [amiantos/lurker](https://github.com/amiantos/lurker).
...
From [amiantos/lurker](https://github.com/amiantos/lurker) — a repo with 67+ stars on GitHub.
