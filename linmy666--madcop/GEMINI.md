...
- **当前版本**: v2.6.5 (Agent 问询机制 + stardew 柔化 + 上下文管理 + Qian control middleware)
...
# 14. (内部信息不写进这个文件, GitHub 是公开仓库)

如果需要联系用户, 优先在本地 `~/.madcop/` 配置 / 用户的 .env / 用户当面沟通。**身份信息不进 `AGENTS.md`, 不进 commit message, 不进公开文档。**
