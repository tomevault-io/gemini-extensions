...
- **ALWAYS** ask me to approve the commit message.
- Once I approve, run .windsurf/scripts/commit.sh

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jonreid) — claim your Tome and manage your conversions.
