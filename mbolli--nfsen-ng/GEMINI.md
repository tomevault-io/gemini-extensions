...
> Use when adding or modifying the $c->view() closure in app.php, or when work involves broadcast performance, throttling expensive RRD/DB reads during imports, or caching per-tab state across re-renders.
