...
Original source: `CLAUDE.md` in [badchars/darknet-mcp-server](https://github.com/badchars/darknet-mcp-server).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/badchars/darknet-mcp-server](https://github.com/badchars/darknet-mcp-server)
