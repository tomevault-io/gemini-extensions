...
> Use when performing git push operations, updating PR branches, or preparing PR-ready commits. Enforces running golangci-lint exactly like CI before any push.
