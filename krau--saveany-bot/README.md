...
Original source: `AGENTS.md` in [krau/SaveAny-Bot](https://github.com/krau/SaveAny-Bot).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/krau/SaveAny-Bot](https://github.com/krau/SaveAny-Bot)
