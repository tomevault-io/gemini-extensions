...
Original source: `CLAUDE.md` in [jhaizhou-ops/karma](https://github.com/jhaizhou-ops/karma).
...
From [jhaizhou-ops/karma](https://github.com/jhaizhou-ops/karma) — a repo with 9+ stars on GitHub.
