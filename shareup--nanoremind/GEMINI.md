...
> Read, create, update, complete, and delete reminders with the nanoremind CLI. Use when working on a Mac where nanoremind is installed and you need Apple Reminders access from the terminal.
