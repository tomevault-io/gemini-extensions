...
- Sentences prefer active voice and natural Chinese word order.
- Paragraphs connect through cause, progression, comparison, or evidence.
- Typst syntax, labels, references, citations, formulas, and code remain valid.
