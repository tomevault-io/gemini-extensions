...
Original source: `AGENTS.md` in [little-pond/axl-light](https://github.com/little-pond/axl-light).
...
```
npx tomevault install little-pond/axl-light
```
Source: [github.com/little-pond/axl-light](https://github.com/little-pond/axl-light).
