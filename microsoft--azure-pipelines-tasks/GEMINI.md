...
> Use when editing, reviewing, or modifying files inside a deprecated Azure Pipelines task. Covers code review warnings, deprecation policy, and guidance to avoid investing in unmaintained tasks.
