...
Original source: `CLAUDE.md` in [Njuelle/Codaholiq](https://github.com/Njuelle/Codaholiq).
...
From [Njuelle/Codaholiq](https://github.com/Njuelle/Codaholiq) — a repo with 9+ stars on GitHub.
