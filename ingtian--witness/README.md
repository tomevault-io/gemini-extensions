...
Original source: `AGENTS.md` in [IngTian/witness](https://github.com/IngTian/witness).
...
From [IngTian/witness](https://github.com/IngTian/witness) — a repo with 8+ stars on GitHub.
