...
Original source: `CLAUDE.md` in [subinium/vibesubin](https://github.com/subinium/vibesubin).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/subinium/vibesubin](https://github.com/subinium/vibesubin)
