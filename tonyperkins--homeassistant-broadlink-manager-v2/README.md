# homeassistant-broadlink-manager-v2
...
Original source: `.windsurf/rules/*.md` in [tonyperkins/homeassistant-broadlink-manager-v2](https://github.com/tonyperkins/homeassistant-broadlink-manager-v2).
