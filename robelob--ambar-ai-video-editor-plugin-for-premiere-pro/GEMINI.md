...
its own SequenceEditor + CEP bridge flow and updates TranscriptStore via its own
reverse-order loop. Silence cuts are structural — everything above the silence layer
uses EditExecutor.
