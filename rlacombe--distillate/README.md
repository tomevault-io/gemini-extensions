...
Original source: `CLAUDE.md` in [rlacombe/distillate](https://github.com/rlacombe/distillate).
...
```
npx tomevault install rlacombe/distillate
```
Source: [github.com/rlacombe/distillate](https://github.com/rlacombe/distillate).
