...
Original source: `CLAUDE.md` in [RoboFinSystems/robosystems](https://github.com/RoboFinSystems/robosystems).
...
From [RoboFinSystems/robosystems](https://github.com/RoboFinSystems/robosystems) — a repo with 13+ stars on GitHub.
