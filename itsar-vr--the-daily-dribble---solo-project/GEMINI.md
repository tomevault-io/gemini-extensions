## the-daily-dribble-solo-project

> Use this rule to write modern SwiftUI code; it outlines idiomatic Swift development practices including state management, async/await usage, view composition, feature‑oriented organization and testing strategies
