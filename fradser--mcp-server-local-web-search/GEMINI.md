...
> This project use bun for runtime.
...
---
> Source: [FradSer/mcp-server-local-web-search](https://github.com/FradSer/mcp-server-local-web-search) — distributed by [TomeVault](https://tomevault.io).
