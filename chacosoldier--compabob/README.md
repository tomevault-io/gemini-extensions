...
Original source: `CLAUDE.md` in [chacosoldier/compabob](https://github.com/chacosoldier/compabob).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/chacosoldier/compabob](https://github.com/chacosoldier/compabob)
