...
Original source: `.cursor/rules/*.mdc` in [espressif/idf-ci](https://github.com/espressif/idf-ci).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/espressif/idf-ci](https://github.com/espressif/idf-ci)
