...
- `worker/` - Cloudflare Worker (cron jobs, RSS fetching, AI summarization, Git operations)
- `hugo-site/` - Hugo static site (content, themes, layouts)
- `config/` - Configuration files (topics.json)
