## godot-youbeatai-main

> Godot 4.6 music-creation game for children. Event-driven architecture with EventBus, static typing, and serializable data classes. Refer to STYLE_GUIDE.md and Ritme Robot Architecture.md for expanded conventions.
