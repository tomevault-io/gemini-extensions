...
> Global agent speech kill switch — when FRIDAY_CURSOR_NARRATION is false, Composer must never call friday-speak or pick-session-voice (overrides all other Friday narration rules)
