## remix-storefront-routing

> Remix storefront routing patterns with React Router v7, TypeScript, and Medusa integration for route structure, forms, and API integration
