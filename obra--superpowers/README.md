# AI instruction files for superpowers

> Sourced from [obra/superpowers](https://github.com/obra/superpowers) and converted for every major platform by [TomeVault](https://tomevault.io)
...
Original source: `CLAUDE.md` in [obra/superpowers](https://github.com/obra/superpowers).
...
- [finding-duplicate-functions](https://github.com/obra/superpowers/tree/main/skills/finding-duplicate-functions)
- [mcp-cli](https://github.com/obra/superpowers/tree/main/skills/mcp-cli)
- [slack-messaging](https://github.com/obra/superpowers/tree/main/skills/slack-messaging)
- [using-tmux-for-interactive-commands](https://github.com/obra/superpowers/tree/main/skills/using-tmux-for-interactive-commands)
- [browsing](https://github.com/obra/superpowers/tree/main/skills/browsing)
- [developing-claude-code-plugins](https://github.com/obra/superpowers/tree/main/skills/developing-claude-code-plugins)
- [workflow](https://github.com/obra/superpowers/tree/main/examples/full-featured-plugin/skills/workflow)
- [working-with-claude-code](https://github.com/obra/superpowers/tree/main/skills/working-with-claude-code)

Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/obra/superpowers](https://github.com/obra/superpowers)
