...
Original source: `AGENTS.md` in [Comfy-Org/ComfyUI-Desktop-2.0-Beta](https://github.com/Comfy-Org/ComfyUI-Desktop-2.0-Beta).
...
```
npx tomevault install Comfy-Org/ComfyUI-Desktop-2.0-Beta
```
Source: [github.com/Comfy-Org/ComfyUI-Desktop-2.0-Beta](https://github.com/Comfy-Org/ComfyUI-Desktop-2.0-Beta).
