...
- E2E テストは `test:playwright` で実行すること

---
> Source: [voluntas/duckdb-wasm-parquet](https://github.com/voluntas/duckdb-wasm-parquet) — distributed by [TomeVault](https://tomevault.io).
