...
> USE WHEN working with YAML frontmatter, file metadata, validation errors, or auto-correction. Provides frontmatter standards, format consistency rules, and validation integration protocols.
