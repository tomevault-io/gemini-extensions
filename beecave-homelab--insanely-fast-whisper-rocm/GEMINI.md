...
> Keep tests fast, deterministic, and hermetic by default; mirror package layout; mock external tools at boundaries; mark heavy/integration/gpu tests opt-in. Designed for consistent, reviewable tests across the repo.
