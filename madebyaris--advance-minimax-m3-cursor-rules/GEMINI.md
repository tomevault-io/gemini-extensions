...
> MiniMax M3 + Cursor 3.7 agent teams: role boundaries, multi-environment handoffs, /best-of-n as a team pattern, escalation, and serial vs parallel team structure.
