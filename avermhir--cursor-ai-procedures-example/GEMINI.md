...
> CRITICAL rule to prevent breaking API contracts without explicit instruction. Do not change field names, request/response structures, or API behavior without being explicitly told to change the contract.
