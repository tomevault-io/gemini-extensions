...
Original source: `AGENTS.md` in [liquidos-ai/AutoAgents](https://github.com/liquidos-ai/AutoAgents).
...
```
npx tomevault install liquidos-ai/AutoAgents
```
Source: [github.com/liquidos-ai/AutoAgents](https://github.com/liquidos-ai/AutoAgents).
