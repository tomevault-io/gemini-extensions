...
> Four-site registry of interactive step component types. Read before adding, renaming, or removing an interactive step component.
...
A shared "name registry" indirection is possible but adds an indirection layer for marginal benefit. The four-site duplication is small, well-isolated, and easy to grep for — the documentation cost is lower than the abstraction cost.
