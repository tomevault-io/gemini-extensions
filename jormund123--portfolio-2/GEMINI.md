...
- `documents`: Raw news articles.
- `evidence`: The link between a document and a commitment, with AI classification stats.
- `polls`: Daily controversial topics generated for user engagement.
