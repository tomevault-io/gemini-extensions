...
Original source: `copilot-instructions.md` in [COVESA/ifex-viewer](https://github.com/COVESA/ifex-viewer).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/COVESA/ifex-viewer](https://github.com/COVESA/ifex-viewer)
