...
Original source: `CLAUDE.md` in [laurigates/foundryvtt-mcp](https://github.com/laurigates/foundryvtt-mcp).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/laurigates/foundryvtt-mcp](https://github.com/laurigates/foundryvtt-mcp)
