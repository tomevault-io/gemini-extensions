...
A task is complete only when the change is focused, readable, secure at its trust boundaries, tested, and documented as needed; applicable checks have been run; and the final report includes:
