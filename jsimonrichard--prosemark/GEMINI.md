...
> House rules for every change — no silent fallbacks, upstream before workaround, generalize don't special-case, one concern per change, plan first, state what is not done.
