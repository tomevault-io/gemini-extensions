...
> Viết/mở rộng/bảo trì automation test (API hoặc UI) với sự hỗ trợ của AI — sinh khung test, chuyển test case thủ công sang script, thêm test cho endpoint/luồng mới.
