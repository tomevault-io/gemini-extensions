...
> Lập chiến lược test / test charter cho một tính năng bằng AI — lên kế hoạch test cho feature/epic/release, viết charter cho phiên exploratory, hoặc quyết định test gì trước và bỏ gì.
