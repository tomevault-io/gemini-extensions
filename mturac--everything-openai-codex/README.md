...
Original source: `AGENTS.md` in [mturac/everything-openai-codex](https://github.com/mturac/everything-openai-codex).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/mturac/everything-openai-codex](https://github.com/mturac/everything-openai-codex)
