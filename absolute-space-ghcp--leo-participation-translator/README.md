...
Original source: `.cursor/rules/*.mdc` in [Absolute-Space-GHCP/leo-participation-translator](https://github.com/Absolute-Space-GHCP/leo-participation-translator).
