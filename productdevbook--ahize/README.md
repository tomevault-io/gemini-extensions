...
Original source: `AGENTS.md` in [productdevbook/ahize](https://github.com/productdevbook/ahize).
...
From [productdevbook/ahize](https://github.com/productdevbook/ahize) — a repo with 14+ stars on GitHub.
