...
**Database schema**: Single `prisma/schema.prisma` file
...
1. **Follow modular architecture** - Respect modules/common boundaries
...
6. **Use the CLI system** - For database operations
