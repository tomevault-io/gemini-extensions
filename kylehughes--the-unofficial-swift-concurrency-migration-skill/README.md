...
Original source: `CLAUDE.md` in [kylehughes/the-unofficial-swift-concurrency-migration-skill](https://github.com/kylehughes/the-unofficial-swift-concurrency-migration-skill).
...
```
npx tomevault install kylehughes/the-unofficial-swift-concurrency-migration-skill
```
Source: [github.com/kylehughes/the-unofficial-swift-concurrency-migration-skill](https://github.com/kylehughes/the-unofficial-swift-concurrency-migration-skill).
