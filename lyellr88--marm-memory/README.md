...
> Tome by [Lyellr88](https://github.com/Lyellr88/marm-memory) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `AGENTS.md` in [Lyellr88/marm-memory](https://github.com/Lyellr88/marm-memory).
...
From [Lyellr88/marm-memory](https://github.com/Lyellr88/marm-memory) — a repo with 307+ stars on GitHub.
