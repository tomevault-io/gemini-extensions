...
> CopilotKit Documentation - Complete CopilotKit framework documentation for AI assistance
...
When installing dependencies for front-end projects, it is recommended to use pnpm first.

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lijie1024512) — claim your Tome and manage your conversions.
