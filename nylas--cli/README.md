...
Original source: `AGENTS.md` in [nylas/cli](https://github.com/nylas/cli).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/nylas/cli](https://github.com/nylas/cli)
