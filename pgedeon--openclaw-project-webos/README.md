...
Original source: `AGENTS.md` in [pgedeon/openclaw-project-webos](https://github.com/pgedeon/openclaw-project-webos).
...
```
npx tomevault install pgedeon/openclaw-project-webos
```
Source: [github.com/pgedeon/openclaw-project-webos](https://github.com/pgedeon/openclaw-project-webos).
