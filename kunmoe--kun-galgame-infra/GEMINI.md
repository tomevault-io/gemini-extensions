...
> Orchestrator/executor split - this agent drafts task books and dispatches them to the local `grok` CLI as executor; only critical, error-prone steps are executed directly
