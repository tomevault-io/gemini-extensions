...
> Route office, Windows, and scripting requests to the right language with safe executable implementations.
...
---
> Source: [imnotStealthy/ai-builder-skill](https://github.com/imnotStealthy/ai-builder-skill) — distributed by [TomeVault](https://tomevault.io).
