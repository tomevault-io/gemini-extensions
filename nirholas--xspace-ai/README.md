...
> Tome by [nirholas](https://github.com/nirholas/xspace-AI) — distributed by [TomeVault](https://tomevault.io)
...
From [nirholas/xspace-AI](https://github.com/nirholas/xspace-AI) — a repo with 15+ stars on GitHub.
