...
Original source: `CLAUDE.md` in [ombulabs/claude-code_dual-boot-skill](https://github.com/ombulabs/claude-code_dual-boot-skill).
...
From [ombulabs/claude-code_dual-boot-skill](https://github.com/ombulabs/claude-code_dual-boot-skill) — a repo with 9+ stars on GitHub.
