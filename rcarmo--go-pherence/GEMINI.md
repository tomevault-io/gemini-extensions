...
24. **31 GB RAM, no swap.** Be conscious of peak memory. Release large temporaries before allocating new ones. Use `runtime.GC()` / `debug.FreeOSMemory()` at phase boundaries for large pipelines.
