...
Original source: `AGENTS.md` in [EliasOenal/term-cli](https://github.com/EliasOenal/term-cli).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/EliasOenal/term-cli](https://github.com/EliasOenal/term-cli)
