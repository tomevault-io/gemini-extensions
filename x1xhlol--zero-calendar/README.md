...
Original source: `AGENTS.md` in [x1xhlol/zero-calendar](https://github.com/x1xhlol/zero-calendar).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/x1xhlol/zero-calendar](https://github.com/x1xhlol/zero-calendar)
