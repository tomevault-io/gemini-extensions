...
> WordPress VIP performance optimization standards. Auto-applies to PHP files.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Strategy11)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Strategy11)
