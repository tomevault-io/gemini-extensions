...
Original source: `AGENTS.md` in [harumiWeb/exstruct](https://github.com/harumiWeb/exstruct).
...
From [harumiWeb/exstruct](https://github.com/harumiWeb/exstruct) — a repo with 136+ stars on GitHub.
