...
Original source: `CLAUDE.md` in [khromov/svelte-bench](https://github.com/khromov/svelte-bench).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/khromov/svelte-bench](https://github.com/khromov/svelte-bench)
