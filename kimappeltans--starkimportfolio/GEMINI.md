...
> When the user asks to sync or import courses from kim_portfolio or clean-portfolio, use this agent to pull course data and course page structure into this repo and recreate every course.
