...
Original source: `AGENTS.md` in [XNet-NGO/aiope](https://github.com/XNet-NGO/aiope).
...
From [XNet-NGO/aiope](https://github.com/XNet-NGO/aiope) — a repo with 15+ stars on GitHub.
