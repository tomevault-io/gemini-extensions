...
Original source: `AGENTS.md` in [clidey/deptrust](https://github.com/clidey/deptrust).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/clidey/deptrust](https://github.com/clidey/deptrust)
