...
```
npx tomevault install kevinkiklee/adobe-plugin-skills
```
Source: [github.com/kevinkiklee/adobe-plugin-skills](https://github.com/kevinkiklee/adobe-plugin-skills).
