...
Original source: `.cursor/rules/*.mdc` in [wiggitywhitney/mcp-commit-story](https://github.com/wiggitywhitney/mcp-commit-story).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/wiggitywhitney/mcp-commit-story](https://github.com/wiggitywhitney/mcp-commit-story)
