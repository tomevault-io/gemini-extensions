## debug-beaker-experiments

> Use when user asks to debug beaker experiments, fix failed jobs, check experiment errors, investigate beaker failures, or troubleshoot training runs
