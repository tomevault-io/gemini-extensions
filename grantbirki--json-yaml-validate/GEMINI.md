...
- Keep implementation changes focused and small. This action is depended on by
  many repositories.
- Prefer understandability over concision and descriptive names over brevity.
...
1. Base new work on the latest `main` branch.
2. Confirm `git status --short` only shows intended files.
