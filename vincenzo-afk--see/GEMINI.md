...
> Use when the user says "use see", "use see cli", or asks to control, operate, click, type, or read the PC / screen / desktop / GUI apps, or when building the `see` CLI project itself.
