...
4. **Code quality** — does it follow conventions (Allman braces, `ops::` namespace, no dynamic allocation after setup)?
...
These are enabled and free for Saitama (public repo):
