...
Apply skills: `.windsurf/skills/spring-boot-4-conventions/SKILL.md`, `archunit-rules/SKILL.md`, `spring-security-baseline/SKILL.md`, `clarity-over-cleverness/SKILL.md`.
