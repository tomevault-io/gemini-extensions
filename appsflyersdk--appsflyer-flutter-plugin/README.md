...
```
npx tomevault install AppsFlyerSDK/appsflyer-flutter-plugin
```
Source: [github.com/AppsFlyerSDK/appsflyer-flutter-plugin](https://github.com/AppsFlyerSDK/appsflyer-flutter-plugin).
