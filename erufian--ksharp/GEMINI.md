...
> Use the following paths to locate documentation about the K language:


Use the following paths to locate documentation about the K language:
- Spec (specifications): T:\\_src\\github.com\\ERufian\\vibe-docs\\ksharp\\speck#.txt
...
- K Reference manual: T:\\_src\\github.com\\ERufian\\vibe-docs\\ksharp\\kref_copilot\\*.md
...
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/ERufian)
