...
Original source: `CLAUDE.md` in [AltanS/collie](https://github.com/AltanS/collie).
...
From [AltanS/collie](https://github.com/AltanS/collie) — a repo with 8+ stars on GitHub.
