...
Original source: `.windsurf/rules/*.md` in [openann19/pets](https://github.com/openann19/pets).
...
Is this your repo? [Claim it](https://tomevault.io/claim/openann19) to manage distribution and track installs.
