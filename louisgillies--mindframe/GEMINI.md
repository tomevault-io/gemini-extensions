...
> Thinking framework skills for AI agents. Install the full plugin for all frameworks. Includes Animal Magic (7 animal-based cognitive modes), Dinner Party (40 historical thinkers debate your ideas), and Cognitive Flex (exercise your reasoning before the AI answers).


# Mindframe

A collection of thinking framework skills for Claude Code.

## Install the Full Plugin

For the complete experience with all thinking frameworks:
...
---
> Source: [louisgillies/mindframe](https://github.com/louisgillies/mindframe) — distributed by [TomeVault](https://tomevault.io).
