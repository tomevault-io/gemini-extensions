...
Original source: `CLAUDE.md` in [not-elm/orzma](https://github.com/not-elm/orzma).
...
From [not-elm/orzma](https://github.com/not-elm/orzma) — a repo with 11+ stars on GitHub.
