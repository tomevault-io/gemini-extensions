...
Original source: `CLAUDE.md` in [TheSylvester/crispy](https://github.com/TheSylvester/crispy).
...
From [TheSylvester/crispy](https://github.com/TheSylvester/crispy) — a repo with 20+ stars on GitHub.
