...
- **Windows**: `C:\Users\[username]\.claude\commands` and `C:\Users\[username]\.claude\skills`
- **macOS/Linux**: `~/.claude/commands` and `~/.claude/skills`
...
- Acceptance-tester skill integration for systematic validation
...
- Acceptance-tester skill integration for comprehensive validation
