...
Original source: `CLAUDE.md` in [parruda/swarm](https://github.com/parruda/swarm).
...
From [parruda/swarm](https://github.com/parruda/swarm) — a repo with 1708+ stars on GitHub.
