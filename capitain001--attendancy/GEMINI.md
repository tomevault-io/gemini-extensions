...
- `docs/techs/stack.md` — stack actuelle et cible de migration (Bun, Tauri, Expo)
- `docs/techs/migration-monorepo.md` — plan de migration monorepo, phases et décisions
