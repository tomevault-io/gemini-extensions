...
Original source: `copilot-instructions.md` in [Skyfay/SkySend](https://github.com/Skyfay/SkySend).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/Skyfay/SkySend](https://github.com/Skyfay/SkySend)
