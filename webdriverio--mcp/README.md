...
Original source: `CLAUDE.md` in [webdriverio/mcp](https://github.com/webdriverio/mcp).
...
From [webdriverio/mcp](https://github.com/webdriverio/mcp) — a repo with 27+ stars on GitHub.
