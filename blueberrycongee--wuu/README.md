...
Original source: `AGENTS.md` in [blueberrycongee/wuu](https://github.com/blueberrycongee/wuu).
...
```
npx tomevault install blueberrycongee/wuu
```
Source: [github.com/blueberrycongee/wuu](https://github.com/blueberrycongee/wuu).
