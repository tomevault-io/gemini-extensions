# AI instruction files for quran-mcp

> Sourced from [quran/quran-mcp](https://github.com/quran/quran-mcp) and converted for every major platform by [TomeVault](https://tomevault.io)
