...
Original source: `AGENTS.md` in [zmandel/demosite_appscript](https://github.com/zmandel/demosite_appscript).
...
```
npx tomevault install zmandel/demosite_appscript
```
Source: [github.com/zmandel/demosite_appscript](https://github.com/zmandel/demosite_appscript).
