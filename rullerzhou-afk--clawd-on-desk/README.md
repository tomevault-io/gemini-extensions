...
Original source: `CLAUDE.md` in [rullerzhou-afk/clawd-on-desk](https://github.com/rullerzhou-afk/clawd-on-desk).
...
From [rullerzhou-afk/clawd-on-desk](https://github.com/rullerzhou-afk/clawd-on-desk) — a repo with 1427+ stars on GitHub.
