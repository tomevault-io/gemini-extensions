...
Original source: `CLAUDE.md` in [tokencanopy/e2a](https://github.com/tokencanopy/e2a).
...
From [tokencanopy/e2a](https://github.com/tokencanopy/e2a) — a repo with 173+ stars on GitHub.
