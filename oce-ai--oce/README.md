...
> Source: [oce-ai/oce](https://github.com/oce-ai/oce). Graded, signed and kept current as the models change by [TomeVault](https://tomevault.io)
...
Original source: `AGENTS.md` in [oce-ai/oce](https://github.com/oce-ai/oce).
...
From [oce-ai/oce](https://github.com/oce-ai/oce) — a repo with 26+ stars on GitHub.
