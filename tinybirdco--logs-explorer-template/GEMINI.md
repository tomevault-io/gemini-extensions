...
- Put all dimensions in the ENGINE_SORTING_KEY, sort first by the lowest granularity and then by the highest.
- If the ENGINE_SORTING_KEY has more than 4 columns, add an ENGINE_PRIMARY_KEY with the first 3 columns of the ENGINE_SORTING_KEY.
</target_datasource_instructions>
