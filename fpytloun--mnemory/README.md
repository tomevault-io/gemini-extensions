...
Original source: `AGENTS.md` in [fpytloun/mnemory](https://github.com/fpytloun/mnemory).
...
From [fpytloun/mnemory](https://github.com/fpytloun/mnemory) — a repo with 93+ stars on GitHub.
