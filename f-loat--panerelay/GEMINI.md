...
The following commands publish immutable versions to the public npm registry. Run them only after an explicit user request, with a clean working tree and an intentionally selected version:
