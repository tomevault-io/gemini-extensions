...
Original source: `copilot-instructions.md` in [microsoft/gitagu](https://github.com/microsoft/gitagu).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/microsoft/gitagu](https://github.com/microsoft/gitagu)
