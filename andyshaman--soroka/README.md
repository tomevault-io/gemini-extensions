...
Original source: `CLAUDE.md` in [AndyShaman/Soroka](https://github.com/AndyShaman/Soroka).
...
From [AndyShaman/Soroka](https://github.com/AndyShaman/Soroka) — a repo with 9+ stars on GitHub.
