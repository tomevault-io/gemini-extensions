...
1. **Builds successfully**: `dotnet build Foundatio.Redis.slnx` exits with code 0
2. **All tests pass**: `dotnet test Foundatio.Redis.slnx` shows no failures
...
# Specific test file
dotnet test --filter "FullyQualifiedName~RedisCacheClientTests"
