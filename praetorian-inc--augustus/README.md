...
Original source: `CLAUDE.md` in [praetorian-inc/augustus](https://github.com/praetorian-inc/augustus).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/praetorian-inc/augustus](https://github.com/praetorian-inc/augustus)
