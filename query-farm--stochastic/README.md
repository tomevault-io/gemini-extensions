...
Original source: `CLAUDE.md` in [Query-farm/stochastic](https://github.com/Query-farm/stochastic).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/Query-farm/stochastic](https://github.com/Query-farm/stochastic)
