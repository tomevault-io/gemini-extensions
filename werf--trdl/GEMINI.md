...
- [werf/common-go](https://github.com/werf/common-go) — Shared Go libraries used by trdl.
- [werf/common-ci](https://github.com/werf/common-ci) — Shared CI/CD task definitions (format, lint). Referenced by root Taskfile.
