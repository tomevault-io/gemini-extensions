...
Original source: `CLAUDE.md` in [blencorp/capture-mcp-server](https://github.com/blencorp/capture-mcp-server).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/blencorp/capture-mcp-server](https://github.com/blencorp/capture-mcp-server)
