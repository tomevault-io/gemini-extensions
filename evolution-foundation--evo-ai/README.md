...
Original source: `.cursor/rules/*.mdc` in [evolution-foundation/evo-ai](https://github.com/evolution-foundation/evo-ai).
...
```
npx tomevault install evolution-foundation/evo-ai
```
Source: [github.com/evolution-foundation/evo-ai](https://github.com/evolution-foundation/evo-ai).
