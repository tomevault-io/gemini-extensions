...
Original source: `.cursor/rules/*.mdc` in [thinktidevibes/2D-Survival-Multiplayer-Game](https://github.com/thinktidevibes/2D-Survival-Multiplayer-Game).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/thinktidevibes/2D-Survival-Multiplayer-Game](https://github.com/thinktidevibes/2D-Survival-Multiplayer-Game)
