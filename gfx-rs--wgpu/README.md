...
> Tome by [gfx-rs](https://github.com/gfx-rs/wgpu), graded and kept true across every major AI platform by [TomeVault](https://tomevault.io)

## Gemini CLI Config

The `GEMINI.md` file in this directory is the project config converted for Gemini CLI.
Original source: `AGENTS.md` in [gfx-rs/wgpu](https://github.com/gfx-rs/wgpu).
