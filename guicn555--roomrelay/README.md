...
Original source: `AGENTS.md` in [guicn555/RoomRelay](https://github.com/guicn555/RoomRelay).
...
```
npx tomevault install guicn555/RoomRelay
```
Source: [github.com/guicn555/RoomRelay](https://github.com/guicn555/RoomRelay).
