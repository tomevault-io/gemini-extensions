...
- Obsidian sample plugin (upstream template): https://github.com/obsidianmd/obsidian-sample-plugin
- Code Graph repository: https://github.com/mrjw717/obsidian-code-graph
