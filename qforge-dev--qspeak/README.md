...
Original source: `.cursor/rules/*.mdc` in [qforge-dev/qspeak](https://github.com/qforge-dev/qspeak).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/qforge-dev/qspeak](https://github.com/qforge-dev/qspeak)
