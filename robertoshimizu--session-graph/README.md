...
Original source: `CLAUDE.md` in [robertoshimizu/session-graph](https://github.com/robertoshimizu/session-graph).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/robertoshimizu/session-graph](https://github.com/robertoshimizu/session-graph)
