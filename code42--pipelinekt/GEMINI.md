...
> [pipelinekt](../../index.md) / [com.code42.jenkins.pipelinekt.dsl.stage](../index.md) / [TopLevelStageContext](index.md) / [agent](./agent.md)
...
---
> Source: [code42/pipelinekt](https://github.com/code42/pipelinekt) — distributed by [TomeVault](https://tomevault.io).
