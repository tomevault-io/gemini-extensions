...
Original source: `CLAUDE.md` in [langchain-ai/open_deep_research](https://github.com/langchain-ai/open_deep_research).
...
```
npx tomevault install langchain-ai/open_deep_research
```
Source: [github.com/langchain-ai/open_deep_research](https://github.com/langchain-ai/open_deep_research).
