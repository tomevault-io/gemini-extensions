...
- Methods, tests, documentation, signposting, logging
- Orchestration, validation, functionality, completeness, accuracy
- Ensure every folder level has accurate and complete AGENTS.md and README.md
- Use professional, effective, real methods that are documented, tested, and have informative logging
- Follow modular, well-documented, clearly reasoned code patterns
- Documentation and descriptions should be understated and "show not tell"
- Scan the repo entirely before acting to ensure intelligent decisions
- Avoid redundant code sections and scripts
- No mock methods - always do real data analysis
