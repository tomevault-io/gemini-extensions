...
Original source: `AGENTS.md` in [marselsel/lexware-mcp](https://github.com/marselsel/lexware-mcp).
...
From [marselsel/lexware-mcp](https://github.com/marselsel/lexware-mcp) — a repo with 8+ stars on GitHub.
