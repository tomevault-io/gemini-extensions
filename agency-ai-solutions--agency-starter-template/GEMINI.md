...
9. We are **not** using pytest for testing. For testing the tools, run the individual tool files. For testing the agents or the agency, execute `agency.get_response` in terminal.
