...
The complete agent definition is available in [.claude/agents/incremental-dev-expert.md](.claude/agents/incremental-dev-expert.md).
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zhiyue) — claim your Tome and manage your conversions.
