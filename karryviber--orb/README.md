...
Original source: `CLAUDE.md` in [KarryViber/Orb](https://github.com/KarryViber/Orb).
...
From [KarryViber/Orb](https://github.com/KarryViber/Orb) — a repo with 50+ stars on GitHub.
