...
Original source: `CLAUDE.md` in [nyo16/net_runner](https://github.com/nyo16/net_runner).
...
From [nyo16/net_runner](https://github.com/nyo16/net_runner) — a repo with 50+ stars on GitHub.
