...
> Guide: docs/development/api-history-migration-guide.md Style rules: docs/development/style-guide.md (see \"API History\" section) Schema: docs/api-history.schema.json Lint: npm run lint:api-history
