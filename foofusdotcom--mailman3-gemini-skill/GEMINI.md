## mailman3-gemini-skill

> Guide for moderating the Mailman 3 system, querying its active SQLite database directly, and adding or removing members without using sudo. Use this when the user needs to in
