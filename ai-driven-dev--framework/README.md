...
Original source: `CLAUDE.md` in [ai-driven-dev/framework](https://github.com/ai-driven-dev/framework).
...
From [ai-driven-dev/framework](https://github.com/ai-driven-dev/framework) — a repo with 32+ stars on GitHub.
