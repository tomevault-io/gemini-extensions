...
> Use when the user wants to collect, review, summarize, or parse videos from their YouTube homepage recommendations, including video links, channel details, metadata, and durations as TOON or JSON.
