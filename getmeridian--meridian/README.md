...
Original source: `CLAUDE.md` in [getmeridian/meridian](https://github.com/getmeridian/meridian).
...
```
npx tomevault install getmeridian/meridian
```
Source: [github.com/getmeridian/meridian](https://github.com/getmeridian/meridian).
