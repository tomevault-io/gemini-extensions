# AI instruction files for background-process-mcp

> Sourced from [waylaidwanderer/background-process-mcp](https://github.com/waylaidwanderer/background-process-mcp) and converted for every major platform by [TomeVault](https://tomevault.io)
