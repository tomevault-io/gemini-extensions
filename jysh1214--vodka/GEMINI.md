...
> Capture and organize a complete snapshot of the user's development environment into a structured YAML format. Use when the user wants to snapshot their dev environment.
