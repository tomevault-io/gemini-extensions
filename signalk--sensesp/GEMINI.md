...
8. **Post-release bump.** New worktree/branch off `origin/main`,
   `bump2version patch` → `X.Y.(Z+1)-alpha`, then PR and merge. Its order
   relative to step 7 does not matter as long as step 7 publishes from the tag.
