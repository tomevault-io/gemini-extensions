...
From [animepics/maestro-ultra](https://github.com/animepics/maestro-ultra) — a repo with 9+ stars on GitHub.

---

Install this config instantly:
```
npx tomevault install animepics/maestro-ultra
```
Source: [github.com/animepics/maestro-ultra](https://github.com/animepics/maestro-ultra).
