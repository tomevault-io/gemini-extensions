...
Original source: `AGENTS.md` in [launchapp-dev/animus-cli](https://github.com/launchapp-dev/animus-cli).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/launchapp-dev/animus-cli](https://github.com/launchapp-dev/animus-cli)
