...
| `typewriter_highlighting_enabled` | Global            | Text highlighting mode on/off (default: true) |
| `typewriter_override_lookup_menu` | Global            | Direct full definition view on single word lookup (default: false) |
