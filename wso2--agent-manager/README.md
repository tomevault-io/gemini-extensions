...
> Tome by [wso2](https://github.com/wso2/agent-manager), graded and kept true across every major AI platform by [TomeVault](https://tomevault.io)
...
```
npx tomevault install wso2/agent-manager
```
Source: [github.com/wso2/agent-manager](https://github.com/wso2/agent-manager).
