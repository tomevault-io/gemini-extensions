...
> Enforce mandatory steps from openspec/config.yaml when creating tasks.md artifacts
...
- Creating `tasks.md` via `/opsx:ff` (fast-forward)
- Creating `tasks.md` via `/opsx:continue` (continue change)
- Updating existing `tasks.md` files
- Any task creation that involves backend changes
- Implementing tasks from `tasks.md` - the agent must execute manual tests
