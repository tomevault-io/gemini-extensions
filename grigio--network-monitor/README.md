...
Original source: `AGENTS.md` in [grigio/network-monitor](https://github.com/grigio/network-monitor).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/grigio/network-monitor](https://github.com/grigio/network-monitor)
