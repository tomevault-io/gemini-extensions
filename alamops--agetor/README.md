...
Original source: `CLAUDE.md` in [alamops/agetor](https://github.com/alamops/agetor).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/alamops/agetor](https://github.com/alamops/agetor)
