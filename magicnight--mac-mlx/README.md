...
Original source: `CLAUDE.md` in [magicnight/Mac-MLX](https://github.com/magicnight/Mac-MLX).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/magicnight/Mac-MLX](https://github.com/magicnight/Mac-MLX)
