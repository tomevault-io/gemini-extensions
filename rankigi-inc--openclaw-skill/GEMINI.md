...
> Governance infrastructure for OpenClaw agents. Every tool call is SHA-256 hashed, hash-chained, and logged to RANKIGI — cryptographically, immutably, honestly.
