...
> Use when: committing changes, reviewing pre-commit code, or requesting pre-push checks. Automatically performs code review, creates Notion summaries, suggests improvements, and asks for approval before pushing.
