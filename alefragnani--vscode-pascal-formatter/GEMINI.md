...
- `extId.commands.newCommand.title`
- `extId.configuration.newSetting.description`
...
- `extId.commands.oldFeature.title`
...
- `extId.configuration.title`: "Pascal"
...
3. **Command IDs** - Must never be translated: `command:_extId.someCommand`
4. **Setting keys** - Must never be translated: `extId.otherSetting`
