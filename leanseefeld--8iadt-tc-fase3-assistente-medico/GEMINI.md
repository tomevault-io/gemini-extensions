## language-conventions-en-code-pt-br-ui

> Assistant replies match the user's message language first; code and URLs in English; UI, human-facing repo docs, and code comments in Português Brasileiro pt-BR.
