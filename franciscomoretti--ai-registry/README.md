...
Original source: `.cursor/rules/*.mdc` in [FranciscoMoretti/ai-registry](https://github.com/FranciscoMoretti/ai-registry).
...
```
npx tomevault install FranciscoMoretti/ai-registry
```
Source: [github.com/FranciscoMoretti/ai-registry](https://github.com/FranciscoMoretti/ai-registry).
