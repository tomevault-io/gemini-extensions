...
Original source: `AGENTS.md` in [flack0x/trendspyg](https://github.com/flack0x/trendspyg).
...
```
npx tomevault install flack0x/trendspyg
```
Source: [github.com/flack0x/trendspyg](https://github.com/flack0x/trendspyg).
