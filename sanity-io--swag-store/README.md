...
Original source: `.cursor/rules/*.mdc` in [sanity-io/swag-store](https://github.com/sanity-io/swag-store).
...
```
npx tomevault install sanity-io/swag-store
```
Source: [github.com/sanity-io/swag-store](https://github.com/sanity-io/swag-store).
