## panel-views-column-relationship

> For any task that relates to filtering of data in panels or views, or more broadly changing the configuration of columns in panels and views.
