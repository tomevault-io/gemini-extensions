...
Original source: `AGENTS.md` in [machulav/accountant24](https://github.com/machulav/accountant24).
...
```
npx tomevault install machulav/accountant24
```
Source: [github.com/machulav/accountant24](https://github.com/machulav/accountant24).
