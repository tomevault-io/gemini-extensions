...
1. You should not stop unitl the user's query is solved.
2. In each query go through the entire project once again.

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/YashM8329) — claim your Tome and manage your conversions.
