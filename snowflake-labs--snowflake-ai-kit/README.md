...
Original source: `AGENTS.md` in [Snowflake-Labs/snowflake-ai-kit](https://github.com/Snowflake-Labs/snowflake-ai-kit).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/Snowflake-Labs/snowflake-ai-kit](https://github.com/Snowflake-Labs/snowflake-ai-kit)
