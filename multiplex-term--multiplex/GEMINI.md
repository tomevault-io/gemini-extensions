...
- `bind-host.md` — Bind Host flow + `mpx` CLI distribution.
- `sync-and-widgets.md` — iCloud Keychain sync, widgets/Shortcuts/external
  actions.
- `release-and-metadata.md` — app icon, release-notes card, App Store
