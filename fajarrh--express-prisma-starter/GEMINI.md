...
- Layer patterns → `.github/instructions/backend-layer.instructions.md`
- Prisma schema conventions → `.github/instructions/prisma.instructions.md`
- frgen usage → `USAGE.md`
