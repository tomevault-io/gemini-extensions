...
> APPLY Angular Material button patterns WHEN implementing buttons to ensure consistent UI/UX, proper accessibility, and adherence to Material Design principles across all button types including text, elevated, outlined, filled, tonal, icon, and FAB variants
