...
Original source: `CLAUDE.md` in [ucsandman/marketing-studio](https://github.com/ucsandman/marketing-studio).
...
```
npx tomevault install ucsandman/marketing-studio
```
Source: [github.com/ucsandman/marketing-studio](https://github.com/ucsandman/marketing-studio).
