...
> How Conductor represents agents: agent definitions compile to workflow graphs, tool calls run as tasks, and workflows invoke agents through the durable AGENT task.
