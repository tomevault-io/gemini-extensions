...
Original source: `CLAUDE.md` in [tansu-io/tansu](https://github.com/tansu-io/tansu).
...
```
npx tomevault install tansu-io/tansu
```
Source: [github.com/tansu-io/tansu](https://github.com/tansu-io/tansu).
