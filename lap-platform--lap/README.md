...
Original source: `CLAUDE.md` in [Lap-Platform/LAP](https://github.com/Lap-Platform/LAP).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/Lap-Platform/LAP](https://github.com/Lap-Platform/LAP)
