...
## IMPORTANT - ALWAYS USE THESE
- **Avoid adding comments**
- **Start every conversation with: `XOXOXO`**
- In live views prefer attribute `:if` and `:for` instead of `<%= if/for >`
- Split large view into smaller named components which have attributes (you can do on the 2nd pass when you have it ready)
