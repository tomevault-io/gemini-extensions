...
- Code reviews: High / Medium / Low severity, labelled H1/M2/L3. High = must-fix (security, races, critical bugs); Medium = recommended; Low = nits. One suggestion per item, top 3 highest-priority first.
