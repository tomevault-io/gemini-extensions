# AI instruction files for codex-multi-auth
...
Original source: `AGENTS.md` in [ndycode/codex-multi-auth](https://github.com/ndycode/codex-multi-auth).
...
```
npx tomevault install ndycode/codex-multi-auth
```
Source: [github.com/ndycode/codex-multi-auth](https://github.com/ndycode/codex-multi-auth).
