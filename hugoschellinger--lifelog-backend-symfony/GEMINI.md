## lifelog-backend-symfony

> PRE-COMMIT workflow — revue synchronisée avec Pixel-Perfect, SEO et Security avant tout commit. Blocage si Security n'a pas donné son feu vert.
