## orchestrator-env-files

> Orchestrator env files must stay in sync with backend GlobalConfig; run env-file check script; prefer --env-file for orchestrator scripts
