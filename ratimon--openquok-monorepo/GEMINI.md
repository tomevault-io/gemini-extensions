...
> When adding or changing env vars — update .env*.example templates and web docs (configuration-web / configuration-backend / configuration-agent); Badge variants; bump lastUpdated
