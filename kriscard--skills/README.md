...
Original source: `CLAUDE.md` in [kriscard/Skills](https://github.com/kriscard/Skills).
...
From [kriscard/Skills](https://github.com/kriscard/Skills) — a repo with 11+ stars on GitHub.
