...
Original source: `CLAUDE.md` in [igerber/diff-diff](https://github.com/igerber/diff-diff).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/igerber/diff-diff](https://github.com/igerber/diff-diff)
