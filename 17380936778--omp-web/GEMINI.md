...
- `ModelsConfig` combines models from `~/.omp/agent/models.yml` with provider auth status from pi's `AuthStorage`/`ModelRegistry`.
...
---
> Source: [17380936778/omp-web](https://github.com/17380936778/omp-web) — distributed by [TomeVault](https://tomevault.io).
