...
Original source: `CLAUDE.md` in [vakovalskii/codbash](https://github.com/vakovalskii/codbash).
...
From [vakovalskii/codbash](https://github.com/vakovalskii/codbash) — a repo with 186+ stars on GitHub.
