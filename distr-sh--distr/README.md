...
Original source: `CLAUDE.md` in [distr-sh/distr](https://github.com/distr-sh/distr).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/distr-sh/distr](https://github.com/distr-sh/distr)
