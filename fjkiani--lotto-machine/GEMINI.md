...
> AI Hedge Fund - objectives, approach, constraints, verification plan, and open questions for live, DP-aware, breakout/reversal detection with robust rate-limit handling
