...
- Temporary `FC_TRACE`-gated `eprintln!` instrumentation for timing investigation currently lives in `fc-core/src/ppu.rs:182,248` (leftover VBL trace) — strip such probes before considering work done.
