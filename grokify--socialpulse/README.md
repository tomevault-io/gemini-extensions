...
> Tome by [grokify](https://github.com/grokify/socialpulse) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `CLAUDE.md` in [grokify/socialpulse](https://github.com/grokify/socialpulse).
...
From [grokify/socialpulse](https://github.com/grokify/socialpulse) — a repo with 0+ stars on GitHub.
