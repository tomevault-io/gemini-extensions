...
Original source: `CLAUDE.md` in [mjherich/memory-visualizer](https://github.com/mjherich/memory-visualizer).
...
From [mjherich/memory-visualizer](https://github.com/mjherich/memory-visualizer) — a repo with 15+ stars on GitHub.
