...
Original source: `AGENTS.md` in [chenhg5/cc-connect](https://github.com/chenhg5/cc-connect).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/chenhg5/cc-connect](https://github.com/chenhg5/cc-connect)
