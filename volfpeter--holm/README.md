...
Original source: `AGENTS.md` in [volfpeter/holm](https://github.com/volfpeter/holm).
...
From [volfpeter/holm](https://github.com/volfpeter/holm) — a repo with 125+ stars on GitHub.
