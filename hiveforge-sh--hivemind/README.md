...
Original source: `copilot-instructions.md` in [hiveforge-sh/hivemind](https://github.com/hiveforge-sh/hivemind).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/hiveforge-sh/hivemind](https://github.com/hiveforge-sh/hivemind)
