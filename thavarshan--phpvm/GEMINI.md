...
> Use when writing or editing bash scripts, BATS tests, or shell helpers. Covers phpvm bash coding standards, variable naming, safe patterns, and testing conventions.
