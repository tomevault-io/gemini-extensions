...
Original source: `AGENTS.md` in [PatrickSys/codebase-context](https://github.com/PatrickSys/codebase-context).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/PatrickSys/codebase-context](https://github.com/PatrickSys/codebase-context)
