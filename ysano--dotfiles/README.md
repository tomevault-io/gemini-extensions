...
Original source: `.cursor/rules/*.mdc` in [ysano/dotfiles](https://github.com/ysano/dotfiles).
...
- [keyboard-config](https://github.com/ysano/dotfiles/tree/main/.claude/skills/keyboard-config)
