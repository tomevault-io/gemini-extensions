...
> Delegate well-specified helper tasks to Gemini CLI (headless). Gemini handles answer/research/review/tests/alt or scoped patch proposals, outputs unified diffs only, and Codex applies edits and runs tests.
