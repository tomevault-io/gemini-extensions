...
> Core TDD workflow rules - Red-Green-Refactor cycle with specialized agents
...
- **COMBINING PHASES** - Never run Green+Refactor in one agent call. Refactor phase requires its own Task with `subagent_type: "refactor"`.
