...
Original source: `AGENTS.md` in [accretional/statue](https://github.com/accretional/statue).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/accretional/statue](https://github.com/accretional/statue)
