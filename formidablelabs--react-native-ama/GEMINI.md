...
├── scripts/              ← state.js (read-only state projection), backlog.js / stories.js / progress.js (ledger writers), chain.js (records chain actions the human struck), verify.js (verification output filter)
