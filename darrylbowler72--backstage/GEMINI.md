...
- **TechDocs**: Uses Docker for local document generation
- **Permission Model**: Currently allow-all (customize before production use)
- **Branch Strategy**: Main branch is `main`, but organization repos may use `master`
