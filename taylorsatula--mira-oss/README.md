...
> Tome by [taylorsatula](https://github.com/taylorsatula/mira-OSS) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `AGENTS.md` in [taylorsatula/mira-OSS](https://github.com/taylorsatula/mira-OSS).
...
From [taylorsatula/mira-OSS](https://github.com/taylorsatula/mira-OSS) — a repo with 448+ stars on GitHub.
