...
Original source: `AGENTS.md` in [teimurjan/lethe](https://github.com/teimurjan/lethe).
...
From [teimurjan/lethe](https://github.com/teimurjan/lethe) — a repo with 9+ stars on GitHub.
