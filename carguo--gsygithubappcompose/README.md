...
Original source: `copilot-instructions.md` in [CarGuo/GSYGithubAppCompose](https://github.com/CarGuo/GSYGithubAppCompose).
...
From [CarGuo/GSYGithubAppCompose](https://github.com/CarGuo/GSYGithubAppCompose) — a repo with 105+ stars on GitHub.
