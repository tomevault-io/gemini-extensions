...
> - The application frontend lives in the directory "client"


# General Info

- The application frontend lives in the directory "client"
- The frontend uses the Astro framework.
...
- Follow the Astro Code Formatting

# Project Structure & Architecture

- The Site is statically built at build time

# Styling & UI

- The site uses the swiss design system
- The github repository is available here: https://github.com/swiss/designsystem

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/swiss)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/swiss)
