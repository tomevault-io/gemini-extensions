...
> Prefer writing self-documenting, readable code over adding explanatory comments. Add comments only when absolutely necessary for complex business logic or non-obvious decisions.
