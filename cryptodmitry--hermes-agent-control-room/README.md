...
Original source: `CLAUDE.md` in [CryptoDmitry/hermes-agent-control-room](https://github.com/CryptoDmitry/hermes-agent-control-room).
...
From [CryptoDmitry/hermes-agent-control-room](https://github.com/CryptoDmitry/hermes-agent-control-room) — a repo with 837+ stars on GitHub.
