...
- `front/src/js/property.js` has a hardcoded Google Maps Embed API key inline (client-side, restrict it by HTTP referrer in Google Cloud Console rather than treating it as secret).
