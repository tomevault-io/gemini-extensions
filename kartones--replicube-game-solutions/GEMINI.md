...
## Usage
Apply this rule when you need to understand or debug optimized Replicube LUA code by converting it to a more readable format that prioritizes clarity over performance.
