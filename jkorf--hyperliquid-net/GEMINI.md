...
> Conventions for using HyperLiquid.Net when working with the HyperLiquid DEX in C#/.NET. Apply when generating code that interacts with the HyperLiquid API.
