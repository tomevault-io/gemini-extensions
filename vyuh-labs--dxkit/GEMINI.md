...
`src/languages/{python,typescript,go,rust,csharp,kotlin,java,ruby,swift,php,abap}.ts`. Dispatch everywhere
...
- `src/languages/{python,typescript,go,rust,csharp,kotlin,java,ruby,swift,php,abap}.ts` — one file per language
