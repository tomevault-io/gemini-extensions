...
Original source: `AGENTS.md` in [Dicklesworthstone/beads_rust](https://github.com/Dicklesworthstone/beads_rust).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/Dicklesworthstone/beads_rust](https://github.com/Dicklesworthstone/beads_rust)
