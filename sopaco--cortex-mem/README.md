...
Original source: `AGENTS.md` in [sopaco/cortex-mem](https://github.com/sopaco/cortex-mem).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/sopaco/cortex-mem](https://github.com/sopaco/cortex-mem)
