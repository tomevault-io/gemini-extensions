...
- [ ] Phase 1：理解核心概念（concepts/）
- [ ] Phase 2：形成自己的观点（thinking/）
- [ ] Phase 3：选一个小项目实践（practice/）
- [ ] Phase 4：记录反馈迭代（feedback/）
- [ ] Phase 5：输出可展示的作品（works/）
...
---
> Source: [deusyu/harness-engineering](https://github.com/deusyu/harness-engineering) — distributed by [TomeVault](https://tomevault.io).
