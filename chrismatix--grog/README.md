...
Original source: `AGENTS.md` in [chrismatix/grog](https://github.com/chrismatix/grog).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/chrismatix/grog](https://github.com/chrismatix/grog)
