...
### Development Workflow
- Follow consistent project structure across packages
- Use comprehensive testing strategies (unit, integration, E2E)
- Implement proper error handling and logging
- Follow established code style guidelines

### API Design
- Design for extensibility and modularity
- Provide clear interfaces and type definitions
...
## References
- [Technical Writing Best Practices](mdc:https:/developers.google.com/tech-writing)
- [TypeScript Documentation](mdc:https:/www.typescriptlang.org/docs)
- [API Design Guidelines](mdc:https:/github.com/microsoft/api-guidelines)
- [Software Architecture Documentation](mdc:https:/c4model.com)
