...
# Modify projects (ALWAYS --dryrun first!)
forklaunch change application --runtime bun --dryrun
forklaunch change service <name> --database mysql --dryrun
...
# SDK management
forklaunch sdk mode --type [generated|live] # Configure SDK generation
```
...
### CLI Usage
❌ Running `forklaunch change` without `--dryrun` first
