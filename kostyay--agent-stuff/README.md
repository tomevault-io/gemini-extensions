...
Original source: `AGENTS.md` in [kostyay/agent-stuff](https://github.com/kostyay/agent-stuff).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/kostyay/agent-stuff](https://github.com/kostyay/agent-stuff)
