...
Original source: `CLAUDE.md` in [lazureykis/throttlecrab](https://github.com/lazureykis/throttlecrab).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/lazureykis/throttlecrab](https://github.com/lazureykis/throttlecrab)
