...
> Documentation and code comments must be written in English, while interactive conversation with the user should generally follow the user's input language.
