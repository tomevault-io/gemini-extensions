...
Original source: `CLAUDE.md` in [alchaincyf/glm-claude](https://github.com/alchaincyf/glm-claude).
...
```
npx tomevault install alchaincyf/glm-claude
```
Source: [github.com/alchaincyf/glm-claude](https://github.com/alchaincyf/glm-claude).
