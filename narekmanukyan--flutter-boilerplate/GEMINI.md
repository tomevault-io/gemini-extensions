...
> Mockito testing framework patterns. Use @GenerateMocks/@GenerateNiceMocks for mock generation, when()/thenReturn() for stubbing, verify() for interaction checking, Fake vs Mock selection, argument matchers (any, argThat, captureAny), and build_runner code generation workflow.
