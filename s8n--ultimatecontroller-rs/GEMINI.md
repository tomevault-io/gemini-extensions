...
- BLE tested with Ultimate BT (PID 0x6007, BLE name "80NA", characteristic FF13)
- USB tested with Ultimate BT in config mode (PID 0x6007)
- AVOID sending cmd=0x0D over HID — it resets/disconnects the controller
