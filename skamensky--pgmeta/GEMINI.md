...
> This rule ensures that when modifying Go files, developers maintain code quality and consistency by adding/updating tests, formatting code, and fixing linting errors.
