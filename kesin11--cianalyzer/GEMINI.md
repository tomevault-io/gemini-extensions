...
> Use when editing the CIAnalyzer config schema, BigQuery schema files, or report shape definitions. Covers keeping the ci_analyzer.yaml schema, BigQuery schemas, source schemas, and docs in sync.
