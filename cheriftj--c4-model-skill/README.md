...
Original source: `CLAUDE.md` in [cheriftj/c4-model-skill](https://github.com/cheriftj/c4-model-skill).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/cheriftj/c4-model-skill](https://github.com/cheriftj/c4-model-skill)
