...
Original source: `AGENTS.md` in [VisionForge-OU/foreman](https://github.com/VisionForge-OU/foreman).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/VisionForge-OU/foreman](https://github.com/VisionForge-OU/foreman)
