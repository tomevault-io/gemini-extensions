## challenge-cap-trainee

> CAP React Persona - Backend Only
...
.github/
├── workflows/
│   ├── service-a.yaml       # CI/CD específico para service-a
│   ├── service-b.yaml       # CI/CD específico para service-b
│   ├── service-c.yaml       # CI/CD específico para service-c
