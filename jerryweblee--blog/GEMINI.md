...
> This rule provides guidelines for server-side development in Nuxt 4, covering API routes, server middleware, database interactions, and server-side rendering best practices.
