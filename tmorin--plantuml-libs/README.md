...
- [plantuml-libs](https://github.com/tmorin/plantuml-libs/tree/main/.github/skills/eip-package-upgrading/SKILL.md)
- [plantuml-libs](https://github.com/tmorin/plantuml-libs/tree/main/.github/skills/azure-package-upgrading/SKILL.md)
- [plantuml-libs](https://github.com/tmorin/plantuml-libs/tree/main/.github/skills/npm-dependency-management/SKILL.md)
...
```
npx tomevault install tmorin/plantuml-libs
```
Source: [github.com/tmorin/plantuml-libs](https://github.com/tmorin/plantuml-libs).
