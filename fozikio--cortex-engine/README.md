...
Original source: `CLAUDE.md` in [Fozikio/cortex-engine](https://github.com/Fozikio/cortex-engine).
...
From [Fozikio/cortex-engine](https://github.com/Fozikio/cortex-engine) — a repo with 48+ stars on GitHub.
