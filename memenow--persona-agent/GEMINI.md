...
- PEP 8 via `ruff` (target-version py311, line-length 88, select E/F/W/I/UP/B/SIM, ignore E501/B008).
- Async-first; `pytest-asyncio` in `asyncio_mode="auto"`.
- Pydantic v2 only (`.model_dump()`, not `.dict()`).
