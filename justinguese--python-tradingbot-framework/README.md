...
Original source: `AGENTS.md` in [JustinGuese/python_tradingbot_framework](https://github.com/JustinGuese/python_tradingbot_framework).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/JustinGuese/python_tradingbot_framework](https://github.com/JustinGuese/python_tradingbot_framework)
