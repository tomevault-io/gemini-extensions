...
Original source: `CLAUDE.md` in [Pokled/nodyx](https://github.com/Pokled/nodyx).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/Pokled/nodyx](https://github.com/Pokled/nodyx)
