...
- New features: deferred props, infinite scrolling (merging props + `WhenVisible`), lazy loading on scroll, polling, prefetching, optimistic updates, instant visits, `useHttp` for standalone requests.
