...
Original source: `CLAUDE.md` in [Freespirits/social-auto-engine](https://github.com/Freespirits/social-auto-engine).
...
From [Freespirits/social-auto-engine](https://github.com/Freespirits/social-auto-engine) — a repo with 8+ stars on GitHub.
