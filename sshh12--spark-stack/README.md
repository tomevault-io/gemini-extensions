...
Original source: `.cursor/rules/*.mdc` in [sshh12/spark-stack](https://github.com/sshh12/spark-stack).
...
From [sshh12/spark-stack](https://github.com/sshh12/spark-stack) — a repo with 276+ stars on GitHub.
