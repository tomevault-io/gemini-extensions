## metal-no-pointer-across-await

> Never hold a resolved cross-module pointer (RegEntry/ImportRow lookup, wasm export/trampoline address) across an await/step boundary
