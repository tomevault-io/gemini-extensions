## metal-no-inline-public-borders

> Cross-module C borders must be real (non-inline) functions — static inline cannot be a link-time ABI symbol, so forge's generated include/ mirror can never carry it faithfully
