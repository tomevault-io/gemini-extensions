## 02-chunking-and-splitting-rules

> Chunking and Text Splitting - Use chunking that preserves coherence while fitting model/token budgets. `src/ai/text-splitter.ts`
