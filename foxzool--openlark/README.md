...
Original source: `AGENTS.md` in [foxzool/openlark](https://github.com/foxzool/openlark).
...
```
npx tomevault install foxzool/openlark
```
Source: [github.com/foxzool/openlark](https://github.com/foxzool/openlark).
