...
Coresearch skills are installed. For broad academic research tasks, load `coresearch` first; for narrow tasks, load the smallest matching skill: `research-design`, `research-survey`, `research-loop`, `research-gap`, `research-dialectic`, `research-causal`, `research-engineer`, `research-qualitative`, `research-write`, `research-review`, `research-rebuttal`, `research-verify`, `research-audit`, `research-adversary`.
