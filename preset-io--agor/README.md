...
Original source: `AGENTS.md` in [preset-io/agor](https://github.com/preset-io/agor).
...
From [preset-io/agor](https://github.com/preset-io/agor) — a repo with 1175+ stars on GitHub.
