...
Original source: `AGENTS.md` in [cola-io/codex-acp](https://github.com/cola-io/codex-acp).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/cola-io/codex-acp](https://github.com/cola-io/codex-acp)
