...
```mermaid
graph TD
    Current["Tài liệu Hiện tại"] --> Active["Đang hoạt động:<br>- creative-phase-metrics.md"]
    Current --> Related["Liên quan:<br>- creative-phase-enforcement.md<br>- creative-phase-architecture.md"]
