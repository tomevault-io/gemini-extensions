...
Original source: `CLAUDE.md` in [chrisryugj/korean-patent-mcp](https://github.com/chrisryugj/korean-patent-mcp).
...
From [chrisryugj/korean-patent-mcp](https://github.com/chrisryugj/korean-patent-mcp) — a repo with 9+ stars on GitHub.
