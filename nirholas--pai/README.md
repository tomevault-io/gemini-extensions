...
> Tome by [nirholas](https://github.com/nirholas/PAI) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `CLAUDE.md` in [nirholas/PAI](https://github.com/nirholas/PAI).
...
From [nirholas/PAI](https://github.com/nirholas/PAI) — a repo with 42+ stars on GitHub.
