...
> Autonomous development squadron for full-stack products. Integrates hierarchical command (Nelson), token-optimized slang (Caveman), and tree-search dashboard (Evo).
