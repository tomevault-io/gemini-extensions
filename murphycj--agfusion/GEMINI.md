...
> Use when writing, editing, or reviewing Python code in the AGFusion package. Covers code style, module responsibilities, testing patterns, and Python-specific conventions.
