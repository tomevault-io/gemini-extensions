...
> Use when modifying FDB sources, CMake configuration, FDB tests, Python or Rust bindings, or validating FDB changes in the ecmwf bundle. Covers linux (and macOS) builds, CTest, clang-format, and clang-tidy.
