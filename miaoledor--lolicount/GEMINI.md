...
后端:Go 1.23+、Fiber v3、go-playground/validator、envconfig、zerolog、modernc.org/sqlite、golang.org/x/image/webp、aws-sdk-go-v2(R2/S3)、embed.FS。
前端:Vue(计划升级 Nuxt 3)、UnoCSS、GSAP、pnpm。
