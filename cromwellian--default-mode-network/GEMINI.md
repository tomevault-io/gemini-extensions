...
> A taste-driven autoresearcher — the idle network of an AI mind. Wanders through the user's interests, hits public search APIs (Wikipedia, ArXiv, HN, DuckDuckGo, ...), scores findings against a virtual-dopamine reward, and writes short markdown briefs to a local journal.
