...
- `rtf.commands.newFile.title`
- `rtf.configuration.newSetting.description`
...
- `rtf.configuration.title`: "RTF"

(Note: Some terms like "RTF" may be intentionally kept in English depending on localization guidelines)
```
...
1. **Product names** - May remain in English: "RTF", "VS Code"
2. **Technical terms** - Some terms may be transliterated rather than translated
3. **Command IDs** - Must never be translated: `command:_rtf.installRtfFormatter`
4. **Setting keys** - Must never be translated: `rtf.otherSetting`
