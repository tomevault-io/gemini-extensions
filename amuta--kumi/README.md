...
From [amuta/kumi](https://github.com/amuta/kumi) — a repo with 74+ stars on GitHub.

---

Install this config instantly:
```
npx tomevault install amuta/kumi
```
Source: [github.com/amuta/kumi](https://github.com/amuta/kumi).
