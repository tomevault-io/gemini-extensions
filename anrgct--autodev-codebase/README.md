...
Original source: `AGENTS.md` in [anrgct/autodev-codebase](https://github.com/anrgct/autodev-codebase).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/anrgct/autodev-codebase](https://github.com/anrgct/autodev-codebase)
