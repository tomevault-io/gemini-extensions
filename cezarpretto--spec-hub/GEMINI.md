...
> Always applied to the SpecHub workspace. Sets Mastra v1, pg/pgvector, local embedding conventions, tool patterns, and testing rules for this MCP server project.
