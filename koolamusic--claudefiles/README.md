...
Original source: `CLAUDE.md` in [koolamusic/claudefiles](https://github.com/koolamusic/claudefiles).
...
```
npx tomevault install koolamusic/claudefiles
```
Source: [github.com/koolamusic/claudefiles](https://github.com/koolamusic/claudefiles).
