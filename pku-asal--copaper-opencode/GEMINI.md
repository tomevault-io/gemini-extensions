...
- `copaper init` is intentionally non-destructive for existing `storyline.md`, `paper.md`, `writingrules.md`, `AGENTS.md`, and already-present skill directories in the target project.
...
- The packaged scaffold lives in `copaper/scaffold/` and must stay synchronized with the source assets in this repository.
