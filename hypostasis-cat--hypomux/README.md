...
Original source: `CLAUDE.md` in [Hypostasis-Cat/HypoMux](https://github.com/Hypostasis-Cat/HypoMux).
...
From [Hypostasis-Cat/HypoMux](https://github.com/Hypostasis-Cat/HypoMux) — a repo with 31+ stars on GitHub.
