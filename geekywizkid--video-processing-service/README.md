...
Original source: `CLAUDE.md` in [GeekyWizKid/video_processing_service](https://github.com/GeekyWizKid/video_processing_service).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/GeekyWizKid/video_processing_service](https://github.com/GeekyWizKid/video_processing_service)
