...
Original source: `AGENTS.md` in [LI-NA/zed-i18n](https://github.com/LI-NA/zed-i18n).
...
From [LI-NA/zed-i18n](https://github.com/LI-NA/zed-i18n) — a repo with 8+ stars on GitHub.
