...
5. `backend/services/plotting.py` → `elif mode == "<id>":` plot branch
...
chmod +x build.sh && ./build.sh        # installs deps, builds frontend → backend/static/
```
...
- Python 3.11, Node 20
- No database — fully stateless request/response
