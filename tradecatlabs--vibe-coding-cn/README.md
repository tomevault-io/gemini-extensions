...
Original source: `AGENTS.md` in [tradecatlabs/vibe-coding-cn](https://github.com/tradecatlabs/vibe-coding-cn).
...
```
npx tomevault install tradecatlabs/vibe-coding-cn
```
Source: [github.com/tradecatlabs/vibe-coding-cn](https://github.com/tradecatlabs/vibe-coding-cn).
