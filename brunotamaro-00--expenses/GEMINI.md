...
- Bot (ruteo/copy/flows): `backend/app/bot/{dispatcher,capture,interactive,manage,recurring,render,state}.py`
- Proxy WhatsApp: `wpp-bot/wpp_bot/{main.py,meta_client.py}`
- Dashboard: `frontend/src/{api,components,pages}/`
