...
Original source: `.cursor/rules/*.mdc` in [rajudandigam/agent-inspect](https://github.com/rajudandigam/agent-inspect).
...
From [rajudandigam/agent-inspect](https://github.com/rajudandigam/agent-inspect) — a repo with 9+ stars on GitHub.
