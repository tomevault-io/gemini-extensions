...
Original source: `copilot-instructions.md` in [kyantech/Palmr](https://github.com/kyantech/Palmr).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/kyantech/Palmr](https://github.com/kyantech/Palmr)
