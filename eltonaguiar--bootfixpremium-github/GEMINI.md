...
Command for the LLM: "Simulate a repair attempt on a drive where manage-bde -status reports 'Locked'. Use the 10-Layer Strategy. Show me the point where Layer 9 (Blast Radius) triggers a HALT."
