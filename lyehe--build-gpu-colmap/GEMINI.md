...
- `COLMAP-4.1.0-Windows-x64-CUDA.zip` - COLMAP 4.1.0 from `build/install/colmap/`
...
**Release Strategy:**
- **COLMAP 4.1.0** - Release version for general use (includes global SfM)
- **pycolmap wheels** - Built from COLMAP 4.1.0, one wheel per Python version
