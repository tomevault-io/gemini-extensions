...
Original source: `AGENTS.md` in [felixtrz/aperture](https://github.com/felixtrz/aperture).
...
From [felixtrz/aperture](https://github.com/felixtrz/aperture) — a repo with 47+ stars on GitHub.
