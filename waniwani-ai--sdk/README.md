...
Original source: `CLAUDE.md` in [WaniWani-AI/sdk](https://github.com/WaniWani-AI/sdk).
...
From [WaniWani-AI/sdk](https://github.com/WaniWani-AI/sdk) — a repo with 12+ stars on GitHub.
