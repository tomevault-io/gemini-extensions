...
> Tome by [jfrog](https://github.com/jfrog/agent-belt) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `AGENTS.md` in [jfrog/agent-belt](https://github.com/jfrog/agent-belt).
...
From [jfrog/agent-belt](https://github.com/jfrog/agent-belt) — a repo with 16+ stars on GitHub.
