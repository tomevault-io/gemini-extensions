...
sleep 3 && tmux capture-pane -t vsurf-test -p

# Send input
tmux send-keys -t vsurf-test "your prompt here" Enter

# Send special keys
tmux send-keys -t vsurf-test Escape
tmux send-keys -t vsurf-test C-o  # ctrl+o

# Cleanup
tmux kill-session -t vsurf-test
```
...
- Changed `vsurf` to open a new chat by default instead of resuming the previous session.
...
- **Internal changes (from issues)**: `Fixed foo bar ([#123](https://github.com/warmshao/vsurf/issues/123))`
- **External contributions**: `Added feature X ([#456](https://github.com/warmshao/vsurf/pull/456) by [@username](https://github.com/username))`
