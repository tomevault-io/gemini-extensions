## arxiv-packager-skill

> Prepare a minimal arXiv submission bundle from a LaTeX project by flattening the paper into one TeX file and copying only required local assets without changing content.
