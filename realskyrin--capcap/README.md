...
Original source: `AGENTS.md` in [realskyrin/capcap](https://github.com/realskyrin/capcap).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/realskyrin/capcap](https://github.com/realskyrin/capcap)
