...
> The rubric should be integrated as a final step in the component design process, where the LLM evaluates its own design recommendations against the established criteria.
