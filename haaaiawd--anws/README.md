...
Original source: `AGENTS.md` in [Haaaiawd/ANWS](https://github.com/Haaaiawd/ANWS).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/Haaaiawd/ANWS](https://github.com/Haaaiawd/ANWS)
