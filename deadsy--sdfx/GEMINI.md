...
- Every SDF-generating function should return `(SDFx, error)`. Use the error for bad parameters and propagate it to the ultimate caller.
- Reserve `panic` for fundamental code problems, not parameter validation.
