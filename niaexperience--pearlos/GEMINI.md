...
- Check `.github/instructions/DOMAIN_SPECIFIC.instructions.md` for specialized patterns
- Check `pearl-docs/internal/ai-assistant-protocol.md` for full protocol specification
