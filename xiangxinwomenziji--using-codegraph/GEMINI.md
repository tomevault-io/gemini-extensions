...
> Use when searching, reading, adding, or modifying code in this workspace. Ensures codegraph MCP tools are consulted first for all code exploration tasks before falling back to Read/Grep/Glob.
