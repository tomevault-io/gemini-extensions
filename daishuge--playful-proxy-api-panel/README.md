...
Original source: `AGENTS.md` in [daishuge/playful-proxy-api-panel](https://github.com/daishuge/playful-proxy-api-panel).
...
```
npx tomevault install daishuge/playful-proxy-api-panel
```
Source: [github.com/daishuge/playful-proxy-api-panel](https://github.com/daishuge/playful-proxy-api-panel).
