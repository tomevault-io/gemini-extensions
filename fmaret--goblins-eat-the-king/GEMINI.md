...
`LocalizationManager` handles French/English text for stat names, effect descriptions, and UI labels. When adding new UI text, route it through the localization system rather than hardcoding strings.
