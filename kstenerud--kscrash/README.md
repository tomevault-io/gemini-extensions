...
Original source: `copilot-instructions.md` in [kstenerud/KSCrash](https://github.com/kstenerud/KSCrash).
...
```
npx tomevault install kstenerud/KSCrash
```
Source: [github.com/kstenerud/KSCrash](https://github.com/kstenerud/KSCrash).
