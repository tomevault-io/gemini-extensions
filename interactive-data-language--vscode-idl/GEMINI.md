...
> TypeScript coding conventions for the vscode-idl codebase — naming, imports, types, null handling, functions, classes, error handling, JSDoc, formatting, and testing patterns
