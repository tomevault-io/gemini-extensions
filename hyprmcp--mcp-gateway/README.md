...
Original source: `CLAUDE.md` in [hyprmcp/mcp-gateway](https://github.com/hyprmcp/mcp-gateway).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/hyprmcp/mcp-gateway](https://github.com/hyprmcp/mcp-gateway)
