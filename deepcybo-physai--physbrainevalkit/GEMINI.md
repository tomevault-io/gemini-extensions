...
- Dataset or file-not-found errors: verify the dataset ID in `scripts/benchmark_registry.py`, check Hub connectivity, and confirm that `HF_HOME` and `HF_DATASETS_CACHE` are writable.
